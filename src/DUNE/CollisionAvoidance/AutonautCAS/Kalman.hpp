...
#ifndef DUNE_COLLISION_AVOIDANCE_AUTONAUTCAS_KALMAN_HPP_INCLUDED_
#define DUNE_COLLISION_AVOIDANCE_AUTONAUTCAS_KALMAN_HPP_INCLUDED_
  ...
  namespace CollisionAvoidance
  {
    namespace AutonautCAS
    {
      ...
      class Kalman
      {
        ...
        */
        void
        init(double t0_, const Eigen::VectorXd& x0)
        {
          x_hat = x0;
          P = P0;
          this->t0 = t0_;
        ...
        */
        void
        update(const Eigen::VectorXd& y, double durationLost)
        {
          if(!initialized)
        ...
        */
        void
        update(const Eigen::VectorXd& y, double durationLost, double dt_, const Eigen::MatrixXd A_)
        {
          this->A = A_;
          this->dt = dt_;
