...
#ifndef DUNE_CONTROL_DISCRETE_PID_head_HPP_INCLUDED_
#define DUNE_CONTROL_DISCRETE_PID_head_HPP_INCLUDED_
...
namespace DUNE
{
  ...
  {
    // Export DLL Symbol.
    class DUNE_DLL_SYM DiscretePID_head;

    class DiscretePID_head
    {
    public:
      //! Constructor.
      DiscretePID_head(void);
