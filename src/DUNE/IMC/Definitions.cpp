...
namespace DUNE
{
  namespace IMC
  {
    ...
    HyperSpecData::HyperSpecData(void)
    {
      m_header.mgid = 710;
      clear();
    }
    ...
    bool
    HyperSpecData::fieldsEqual(const Message& msg__) const
    {
      const IMC::HyperSpecData& other__ = static_cast<const HyperSpecData&>(msg__);
      if (wavelen != other__.wavelen) return false;
    ...
    int
    HyperSpecData::validate(void) const
    {
      return false;
    }

    uint8_t*
    HyperSpecData::serializeFields(uint8_t* bfr__) const
    {
      uint8_t* ptr__ = bfr__;
      ptr__ += IMC::serialize(wavelen, ptr__);
    ...
    uint16_t
    HyperSpecData::deserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(wavelen, bfr__, size__);
    ...
    uint16_t
    HyperSpecData::reverseDeserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::reverseDeserialize(wavelen, bfr__, size__);
      bfr__ += IMC::reverseDeserialize(gain, bfr__, size__);
      bfr__ += IMC::reverseDeserialize(data, bfr__, size__);
      return bfr__ - start__;
    }

    void
    HyperSpecData::fieldsToJSON(std::ostream& os__, unsigned nindent__) const
    {
      IMC::toJSON(os__, "wavelen", wavelen, nindent__);
      IMC::toJSON(os__, "gain", gain, nindent__);
      IMC::toJSON(os__, "data", data, nindent__);
    }

    HyperSnapshot::HyperSnapshot(void)
    {
      m_header.mgid = 711;
      clear();
      data.setParent(this);
    ...
    void
    HyperSnapshot::clear(void)
    {
      data.clear();
    }

    bool
    HyperSnapshot::fieldsEqual(const Message& msg__) const
    {
      const IMC::HyperSnapshot& other__ = static_cast<const HyperSnapshot&>(msg__);
      if (data != other__.data) return false;
      return true;
    }

    int
    HyperSnapshot::validate(void) const
    {
      return false;
    }

    uint8_t*
    HyperSnapshot::serializeFields(uint8_t* bfr__) const
    {
      uint8_t* ptr__ = bfr__;
      ptr__ += data.serialize(ptr__);
      return ptr__;
    ...
    uint16_t
    HyperSnapshot::deserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += data.deserialize(bfr__, size__);
      return bfr__ - start__;
    ...
    uint16_t
    HyperSnapshot::reverseDeserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += data.reverseDeserialize(bfr__, size__);
      return bfr__ - start__;
    ...
    void
    HyperSnapshot::fieldsToJSON(std::ostream& os__, unsigned nindent__) const
    {
      data.toJSON(os__, "data", nindent__);
    }

    void
    HyperSnapshot::setTimeStampNested(double value__)
    {
      data.setTimeStamp(value__);
    }

    void
    HyperSnapshot::setSourceNested(uint16_t value__)
    {
      data.setSource(value__);
    }

    void
    HyperSnapshot::setSourceEntityNested(uint8_t value__)
    {
      data.setSourceEntity(value__);
    }

    void
    HyperSnapshot::setDestinationNested(uint16_t value__)
    {
      data.setDestination(value__);
    }

    void
    HyperSnapshot::setDestinationEntityNested(uint8_t value__)
    {
      data.setDestinationEntity(value__);
    }

    HyperSnapRequest::HyperSnapRequest(void)
    {
      m_header.mgid = 712;
      clear();
    }
    ...
    void
    HyperSnapRequest::clear(void)
    {
      wavelengths.clear();
    }

    bool
    HyperSnapRequest::fieldsEqual(const Message& msg__) const
    {
      const IMC::HyperSnapRequest& other__ = static_cast<const HyperSnapRequest&>(msg__);
      if (wavelengths != other__.wavelengths) return false;
      return true;
    }

    int
    HyperSnapRequest::validate(void) const
    {
      return false;
    }

    uint8_t*
    HyperSnapRequest::serializeFields(uint8_t* bfr__) const
    {
      uint8_t* ptr__ = bfr__;
      ptr__ += IMC::serialize(wavelengths, ptr__);
      return ptr__;
    }

    uint16_t
    HyperSnapRequest::deserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(wavelengths, bfr__, size__);
      return bfr__ - start__;
    }

    uint16_t
    HyperSnapRequest::reverseDeserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::reverseDeserialize(wavelengths, bfr__, size__);
      return bfr__ - start__;
    }

    void
    HyperSnapRequest::fieldsToJSON(std::ostream& os__, unsigned nindent__) const
    {
      IMC::toJSON(os__, "wavelengths", wavelengths, nindent__);
    }
