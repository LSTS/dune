...
namespace DUNE
{
  namespace IMC
  {
    ...
    DeviceUpdate::DeviceUpdate(void)
    {
      m_header.mgid = 874;
      clear();
    }
    ...
    bool
    DeviceUpdate::fieldsEqual(const Message& msg__) const
    {
      const IMC::DeviceUpdate& other__ = dynamic_cast<const DeviceUpdate&>(msg__);
      if (imc_id != other__.imc_id) return false;
      if (unix_time != other__.unix_time) return false;
    ...
    int
    DeviceUpdate::validate(void) const
    {
      return false;
    }

    uint8_t*
    DeviceUpdate::serializeFields(uint8_t* bfr__) const
    {
      uint8_t* ptr__ = bfr__;
      ptr__ += IMC::serialize(imc_id, ptr__);
      ptr__ += IMC::serialize(unix_time, ptr__);
    ...
    uint16_t
    DeviceUpdate::deserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(imc_id, bfr__, size__);
      bfr__ += IMC::deserialize(unix_time, bfr__, size__);
    ...
    uint16_t
    DeviceUpdate::reverseDeserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::reverseDeserialize(imc_id, bfr__, size__);
      bfr__ += IMC::reverseDeserialize(unix_time, bfr__, size__);
    ...
    void
    DeviceUpdate::fieldsToJSON(std::ostream& os__, unsigned nindent__) const
    {
      IMC::toJSON(os__, "imc_id", imc_id, nindent__);
      IMC::toJSON(os__, "unix_time", unix_time, nindent__);
      IMC::toJSON(os__, "latitude", latitude, nindent__);
      IMC::toJSON(os__, "longitude", longitude, nindent__);
    }

    DeviceUpdates::DeviceUpdates(void)
    {
      m_header.mgid = 873;
      clear();
      positions.setParent(this);
    }

    void
    DeviceUpdates::clear(void)
    {
      positions.clear();
    }

    bool
    DeviceUpdates::fieldsEqual(const Message& msg__) const
    {
      const IMC::DeviceUpdates& other__ = dynamic_cast<const DeviceUpdates&>(msg__);
      if (positions != other__.positions) return false;
      return true;
    }

    int
    DeviceUpdates::validate(void) const
    {
      return false;
    }

    uint8_t*
    DeviceUpdates::serializeFields(uint8_t* bfr__) const
    {
      uint8_t* ptr__ = bfr__;
      ptr__ += positions.serialize(ptr__);
      return ptr__;
    }

    uint16_t
    DeviceUpdates::deserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += positions.deserialize(bfr__, size__);
      return bfr__ - start__;
    }

    uint16_t
    DeviceUpdates::reverseDeserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += positions.reverseDeserialize(bfr__, size__);
      return bfr__ - start__;
    }

    void
    DeviceUpdates::fieldsToJSON(std::ostream& os__, unsigned nindent__) const
    {
      positions.toJSON(os__, "positions", nindent__);
    }

    void
    DeviceUpdates::setTimeStampNested(double value__)
    {
      positions.setTimeStamp(value__);
    }

    void
    DeviceUpdates::setSourceNested(uint16_t value__)
    {
      positions.setSource(value__);
    }

    void
    DeviceUpdates::setSourceEntityNested(uint8_t value__)
    {
      positions.setSourceEntity(value__);
    }

    void
    DeviceUpdates::setDestinationNested(uint16_t value__)
    {
      positions.setDestination(value__);
    }

    void
    DeviceUpdates::setDestinationEntityNested(uint8_t value__)
    {
      positions.setDestinationEntity(value__);
    }

    IridiumSubscription::IridiumSubscription(void)
    {
      m_header.mgid = 875;
      clear();
    }
    ...
    void
    IridiumSubscription::clear(void)
    {
      req_type = 0;
    }

    bool
    IridiumSubscription::fieldsEqual(const Message& msg__) const
    {
      const IMC::IridiumSubscription& other__ = dynamic_cast<const IridiumSubscription&>(msg__);
      if (req_type != other__.req_type) return false;
      return true;
    }

    int
    IridiumSubscription::validate(void) const
    {
      return false;
    }

    uint8_t*
    IridiumSubscription::serializeFields(uint8_t* bfr__) const
    {
      uint8_t* ptr__ = bfr__;
      ptr__ += IMC::serialize(req_type, ptr__);
      return ptr__;
    }

    uint16_t
    IridiumSubscription::deserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(req_type, bfr__, size__);
      return bfr__ - start__;
    }

    uint16_t
    IridiumSubscription::reverseDeserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(req_type, bfr__, size__);
      return bfr__ - start__;
    ...
    void
    IridiumSubscription::fieldsToJSON(std::ostream& os__, unsigned nindent__) const
    {
      IMC::toJSON(os__, "req_type", req_type, nindent__);
    }

    AssetPosition::AssetPosition(void)
    {
      m_header.mgid = 876;
      clear();
    }
    ...
    void
    AssetPosition::clear(void)
    {
      pos_type = 0;
    }

    bool
    AssetPosition::fieldsEqual(const Message& msg__) const
    {
      const IMC::AssetPosition& other__ = dynamic_cast<const AssetPosition&>(msg__);
      if (pos_type != other__.pos_type) return false;
      return true;
    }

    int
    AssetPosition::validate(void) const
    {
      return false;
    }

    uint8_t*
    AssetPosition::serializeFields(uint8_t* bfr__) const
    {
      uint8_t* ptr__ = bfr__;
      ptr__ += IMC::serialize(pos_type, ptr__);
      return ptr__;
    }

    uint16_t
    AssetPosition::deserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(pos_type, bfr__, size__);
      return bfr__ - start__;
    }

    uint16_t
    AssetPosition::reverseDeserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(pos_type, bfr__, size__);
      return bfr__ - start__;
    ...
    void
    AssetPosition::fieldsToJSON(std::ostream& os__, unsigned nindent__) const
    {
      IMC::toJSON(os__, "pos_type", pos_type, nindent__);
    }
