...
namespace DUNE
{
  namespace IMC
  {
    ...
    SatelliteRequest::SatelliteRequest(void)
    {
      m_header.mgid = 523;
      clear();
    }
    ...
    bool
    SatelliteRequest::fieldsEqual(const Message& msg__) const
    {
      const IMC::SatelliteRequest& other__ = static_cast<const SatelliteRequest&>(msg__);
      if (req_id != other__.req_id) return false;
      if (destination != other__.destination) return false;
      if (ttl != other__.ttl) return false;
      if (data != other__.data) return false;
    ...
    int
    SatelliteRequest::validate(void) const
    {
      return true;
    }

    uint8_t*
    SatelliteRequest::serializeFields(uint8_t* bfr__) const
    {
      uint8_t* ptr__ = bfr__;
      ptr__ += IMC::serialize(req_id, ptr__);
      ptr__ += IMC::serialize(destination, ptr__);
    ...
    uint16_t
    SatelliteRequest::deserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(req_id, bfr__, size__);
      bfr__ += IMC::deserialize(destination, bfr__, size__);
    ...
    uint16_t
    SatelliteRequest::reverseDeserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::reverseDeserialize(req_id, bfr__, size__);
      bfr__ += IMC::reverseDeserialize(destination, bfr__, size__);
    ...
    void
    SatelliteRequest::fieldsToJSON(std::ostream& os__, unsigned nindent__) const
    {
      IMC::toJSON(os__, "req_id", req_id, nindent__);
      IMC::toJSON(os__, "destination", destination, nindent__);
      IMC::toJSON(os__, "ttl", ttl, nindent__);
    ...
    bool
    SatelliteStatus::fieldsEqual(const Message& msg__) const
    {
      const IMC::SatelliteStatus& other__ = static_cast<const SatelliteStatus&>(msg__);
      if (req_id != other__.req_id) return false;
      if (status != other__.status) return false;
      if (info != other__.info) return false;
      return true;
    ...
    int
    SatelliteStatus::validate(void) const
    {
      return true;
    }

    uint8_t*
    SatelliteStatus::serializeFields(uint8_t* bfr__) const
    {
      uint8_t* ptr__ = bfr__;
      ptr__ += IMC::serialize(req_id, ptr__);
      ptr__ += IMC::serialize(status, ptr__);
    ...
    uint16_t
    SatelliteStatus::deserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(req_id, bfr__, size__);
      bfr__ += IMC::deserialize(status, bfr__, size__);
    ...
    uint16_t
    SatelliteStatus::reverseDeserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::reverseDeserialize(req_id, bfr__, size__);
      bfr__ += IMC::deserialize(status, bfr__, size__);
    ...
    void
    SatelliteStatus::fieldsToJSON(std::ostream& os__, unsigned nindent__) const
    {
      IMC::toJSON(os__, "req_id", req_id, nindent__);
      IMC::toJSON(os__, "status", status, nindent__);
      IMC::toJSON(os__, "info", info, nindent__);
