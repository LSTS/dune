...
#define DUNE_IMC_CONST_GIT_INFO "2017-04-10 0bf0537  (HEAD -> feature/docking, origin/feature/docking)"
//! MD5 sum of XML specification file.
#define DUNE_IMC_CONST_MD5 "da7d6a5b11db2e9741435aa292a5a5d1"
