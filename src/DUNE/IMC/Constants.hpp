...
#define DUNE_IMC_CONST_GIT_INFO "2014-09-18 550440c  (HEAD, tag: imc-5.4.3, origin/master, origin/HEAD, master)"
//! MD5 sum of XML specification file.
#define DUNE_IMC_CONST_MD5 "4ab0411c6256574a5ac1785347d0a9f2"
