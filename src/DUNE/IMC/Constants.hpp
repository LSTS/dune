...
#define DUNE_IMC_CONST_GIT_INFO "2026-05-10 cc0aadf  (HEAD -> feature/ftp_request, origin/feature/ftp_request)"
//! MD5 sum of XML specification file.
#define DUNE_IMC_CONST_MD5 "3702d87736576a3bee5c6628ee3aa89f"
