...
#define DUNE_IMC_CONST_GIT_INFO "2022-06-27 ccaad20  (HEAD -> project/oceantech, origin/project/oceantech)"
//! MD5 sum of XML specification file.
#define DUNE_IMC_CONST_MD5 "7241246f65440cf326778a33996444d8"
