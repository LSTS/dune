...
#define DUNE_IMC_CONST_GIT_INFO "2015-06-29 c0260a6  (HEAD, tag: imc-5.4.5, origin/master, origin/HEAD, master)"
//! MD5 sum of XML specification file.
#define DUNE_IMC_CONST_MD5 "46963dd0144367b7b8ebe169ae5edf4d"
