...
#define DUNE_IMC_CONST_GIT_INFO "2015-12-22 3bc5d8b  (HEAD, tag: imc-5.4.7, origin/master, origin/HEAD, master)"
//! MD5 sum of XML specification file.
#define DUNE_IMC_CONST_MD5 "65ba2ee1d64e9a3f35837bb8072848b4"
