...
#define DUNE_IMC_CONST_GIT_INFO "2014-09-09 bdac7f8  (HEAD, tag: imc-5.4.2, origin/release/imc-5.4.x)"
//! MD5 sum of XML specification file.
#define DUNE_IMC_CONST_MD5 "bc9d825ba1981fbb15950278b9fa89ba"
