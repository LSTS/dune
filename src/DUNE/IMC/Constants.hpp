...
#define DUNE_IMC_CONST_GIT_INFO "2018-04-19 3c77422  (HEAD -> project/fire-rs, origin/master, origin/HEAD, master)"
//! MD5 sum of XML specification file.
#define DUNE_IMC_CONST_MD5 "6ed42ce10f9e69cbd84b1fe2272a8a38"
