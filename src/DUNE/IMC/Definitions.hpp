...
namespace DUNE
{
  namespace IMC
  {
    ...
    //! Entity Control.
    class EntityControl: public Message
    {
    public:
      //! Operation.
      enum OperationEnum
      ...
      getId(void) const
      {
        return EntityControl::getIdStatic();
      }
    ...
    public:
      ...
      getVariableSerializationSize(void) const
      {
        return IMC::getSerializationSize(section) + IMC::getSerializationSize(param) + IMC::getSerializationSize(value);
      }
    ...
    //! Parameters Control.
    class ParameterControl: public Message
    {
    public:
      //! Operation.
      enum OperationEnum
      ...
      getId(void) const
      {
        return ParameterControl::getIdStatic();
      }
      ...
      getVariableSerializationSize(void) const
      {
        return params.getSerializationSize();
      }
    ...
    //! LBL Detection.
    class LblDetection: public Message
    {
    public:
      //! Transmission.
      uint8_t tx;
      ...
      getId(void) const
      {
        return LblDetection::getIdStatic();
      }
    ...
    //! Acoustic Range.
    class AcousticRange: public Message
    {
    public:
      ...
      getId(void) const
      {
        return AcousticRange::getIdStatic();
      }

      const char*
      getName(void) const
      {
        return "AcousticRange";
      }
    ...
    class AcousticRangeReply: public Message
    {
    public:
      //! Status.
      enum StatusEnum
      ...
      AcousticRangeReply(void);

      Message*
      clone(void) const
      {
        return new AcousticRangeReply(*this);
      }
      ...
      getId(void) const
      {
        return AcousticRangeReply::getIdStatic();
      }

      const char*
      getName(void) const
      {
        return "AcousticRangeReply";
      }
    ...
    //! Acoustic Diagnostic.
    class AcousticDiagnostic: public Message
    {
    public:
      //! Enable.
      uint8_t enable;
      ...
      AcousticDiagnostic(void);

      Message*
      clone(void) const
      {
        return new AcousticDiagnostic(*this);
      }
      ...
      getId(void) const
      {
        return AcousticDiagnostic::getIdStatic();
      }

      const char*
      getName(void) const
      {
        return "AcousticDiagnostic";
      }
    ...
    //! Acoustic Noise.
    class AcousticNoise: public Message
    {
    public:
      //! Summary.
      enum SummaryEnum
      ...
      getId(void) const
      {
        return AcousticNoise::getIdStatic();
      }
    ...
    //! Acoustic Ping.
    class AcousticPing: public Message
    {
    public:
      ...
      getId(void) const
      {
        return AcousticPing::getIdStatic();
      }
    ...
    //! Acoustic Ping Reply.
    class AcousticPingReply: public Message
    {
    public:
      ...
      AcousticPingReply(void);

      Message*
      clone(void) const
      {
        return new AcousticPingReply(*this);
      }
      ...
      getId(void) const
      {
        return AcousticPingReply::getIdStatic();
      }

      const char*
      getName(void) const
      {
        return "AcousticPingReply";
      }
    ...
    //! Sonar Configuration.
    class SonarConfig: public Payload
    {
    public:
      //! Frequency.
      uint32_t frequency;
      ...
      getId(void) const
      {
        return SonarConfig::getIdStatic();
      }
    ...
    //! Device Update.
    class DeviceUpdate: public Message
    {
    public:
      //! IMC Identifier.
      uint16_t imc_id;
      ...
      getId(void) const
      {
        return DeviceUpdate::getIdStatic();
      }
    ...
    //! Device Updates.
    class DeviceUpdates: public Message
    {
    public:
      //! Positions.
      MessageList<DeviceUpdate> positions;
      ...
      getId(void) const
      {
        return DeviceUpdates::getIdStatic();
      }
      ...
      getVariableSerializationSize(void) const
      {
        return positions.getSerializationSize();
      }
    ...
    class IridiumSubscription: public Message
    {
    public:
      //! Request Type.
      ...
      IridiumSubscription(void);

      Message*
      clone(void) const
      {
        return new IridiumSubscription(*this);
      }
      ...
      getId(void) const
      {
        return IridiumSubscription::getIdStatic();
      }

      const char*
      getName(void) const
      {
        return "IridiumSubscription";
      }
    ...
    //! Asset Position.
    class AssetPosition: public Message
    {
    public:
      //! Position Type.
      enum PositionTypeEnum
      {
        //! Desired Asset Position.
        POS_DESIRED = 1,
      ...
      getId(void) const
      {
        return AssetPosition::getIdStatic();
      }
