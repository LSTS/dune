...
namespace DUNE
{
  namespace IMC
  {
    ...
    //! HyperSpectral Data.
    class HyperSpecData: public Message
    {
    public:
      //! Wavelength.
      fp32_t wavelen;
      ...
      getId(void) const
      {
        return HyperSpecData::getIdStatic();
      }

      const char*
      getName(void) const
      {
        return "HyperSpecData";
      }
    ...
    class HyperSnapshot: public Message
    {
    public:
      //! Spectral Data.
      MessageList<HyperSpecData> data;
      ...
      getId(void) const
      {
        return HyperSnapshot::getIdStatic();
      }

      const char*
      getName(void) const
      {
        return "HyperSnapshot";
      }
    ...
    //! HyperSpectral Snapshot Request.
    class HyperSnapRequest: public Message
    {
    public:
      //! Wavelengths.
      ...
      HyperSnapRequest(void);

      Message*
      clone(void) const
      {
        return new HyperSnapRequest(*this);
      }
      ...
      getId(void) const
      {
        return HyperSnapRequest::getIdStatic();
      }

      const char*
      getName(void) const
      {
        return "HyperSnapRequest";
      }
      ...
      getVariableSerializationSize(void) const
      {
        return IMC::getSerializationSize(wavelengths);
      }
