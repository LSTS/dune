...
namespace DUNE
{
  namespace IMC
  {
    ...
    //! Start On Maneuver.
    class StartOnManeuver: public Message
    {
    public:
      //! Maneuver Identifier.
      std::string man_id;
      ...
      StartOnManeuver(void);

      StartOnManeuver*
      clone(void) const
      {
        return new StartOnManeuver(*this);
      }
      ...
      getId(void) const
      {
        return StartOnManeuver::getIdStatic();
      }

      const char*
      getName(void) const
      {
        return "StartOnManeuver";
      }
      ...
      getVariableSerializationSize(void) const
      {
        return IMC::getSerializationSize(man_id);
      }
