...
namespace DUNE
{
  namespace IMC
  {
    ...
    //! Satellite Transmission Request.
    ...
    public:
      ...
      SatelliteRequest(void);

      SatelliteRequest*
      clone(void) const
      {
        return new SatelliteRequest(*this);
      }
      ...
      getId(void) const
      {
        return SatelliteRequest::getIdStatic();
      }
    ...
    class SatelliteStatus: public Message
    {
    public:
      //! Status Code.
      enum StatusCodeEnum
      ...
      getId(void) const
      {
        return SatelliteStatus::getIdStatic();
      }
