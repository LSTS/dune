...
#ifndef USERINTERFACES_WEBPAGE_REQUEST_HANDLER_HPP_INCLUDED_
#define USERINTERFACES_WEBPAGE_REQUEST_HANDLER_HPP_INCLUDED_
...
namespace UserInterfaces
{
  namespace Webpage
  {
    ...
    public:
      ...
      void
      sendResponse(TCPSocket* sock, std::string status);
