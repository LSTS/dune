  ...
  namespace Path
  {
    namespace CAS
    {
      ...
      public:
        ...
        checkTransect(double startLat, double startLon, double endLat, double endLon, double grid_size, std::string tablename) // Add depth limit
        {
        ...
        bool writeCSVfile(const ENCManager::DepthSoundingVector &vec, const std::string &outputFile)
        {
