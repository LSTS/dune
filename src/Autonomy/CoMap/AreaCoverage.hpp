...
namespace Autonomy
{
  namespace CoMap
  {
     ...
     * @param[out] isInSegment Set to true if intersection exists (inside the segments)
     * @return Math::Matrix The intersection point which may be inside or outside the segments.
     */
    Math::Matrix
