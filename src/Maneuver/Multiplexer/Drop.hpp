  ...
  namespace Multiplexer
  {
    ...
    public:
      ...
      onPathControlState(const IMC::PathControlState* pcs)
      {
        ...
        {
          IMC::pwmBBB openServo;
          openServo.servstat = IMC::pwmBBB::SERVSTAT_OPEN;
          openServo.servmin = 10;
          openServo.servmax = 30;
          m_task->dispatch(openServo);
          std::cout << "SENDING OPEN SERVO " << std::endl;
