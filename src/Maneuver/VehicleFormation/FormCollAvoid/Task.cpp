    ...
    struct Task: public DUNE::Tasks::Task
    {
      ...
      consume(const IMC::EstimatedState* msg)
      {
        ...
        double d_form_turnrate = d_g * std::tan(m_leader(6))/d_leader_gndspeed*
            std::cos(std::atan2(vd_LeadState(5), vd_LeadState(4)) - vd_LeadState(9));
        d_FormRad = d_leader_gndspeed/d_form_turnrate;
        // d_FormRad = d_leader_gndspeed^2/(d_g * std::tan(vd_LeadState(7))*...
        //     std::cos(std::atan2(vd_LeadState(5), vd_LeadState(4)) - vd_LeadState(9)));
        // d_form_turnrate = d_leader_gndspeed/d_FormRad;
        ...
        //         // - Velocity
        //         vd_FormVel1 = [-vd_FormPos1(2); vd_FormPos1(1)] * d_form_turnrate;
        //         // - Acceleration
        //         vd_FormAcc1 = -vd_FormPos1 * d_form_turnrate^2;
        else
          vd_FormPos1 = md_FormPos(1:2, ind_UAV);
        ...
        d_InterUAVangle = std::atan2(vd_InterUAVState(2), ...
                                vd_InterUAVState(1));
        ...
        //         // - Velocity
        //         vd_InterUAVDesVel = [-vd_Err(2); vd_Err(1)] * d_form_turnrate;
        //         // - Acceleration
        //         vd_InterUAVDesAcc = -vd_Err * d_form_turnrate^2;
        else
        ...
        //                 d_form_turnrate;
        //             // - Acceleration
        //             vd_FormAcc2 = -vd_FormPos2 * d_form_turnrate^2;
        else
        ...
        -vd_InterUAVState(1)] * d_form_turnrate;
        // - Acceleration
        ...
        vd_Err = -vd_InterUAVState(1:2) - vd_InterUAVDesPos;
        // - Velocity
        vd_InterUAVDesVel = [vd_InterUAVState(2); -vd_InterUAVState(1)] * d_form_turnrate;
        // - Acceleration
        vd_InterUAVDesAcc = vd_InterUAVState(1:2) * d_form_turnrate^2;
        //     // - Velocity
        //     vd_InterUAVDesVel = md_RotForm * vd_FormVel1;
        //     // - Acceleration
        //     vd_InterUAVDesAcc = md_RotForm * vd_FormAcc1;
