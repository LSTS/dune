    ...
    public:
        ...
        m_state(PS_NONE)
      {
        dbCreate("CREATE TABLE IF NOT EXISTS mtx ("
                 ...
                 "  mtx_temp   REAL NOT NULL,"
                 "  mtx_accl_x REAL NOT NULL,"
                 "  mtx_accl_y REAL NOT NULL,"
                 "  mtx_accl_z REAL NOT NULL,"
                 "  mtx_avel_x REAL NOT NULL,"
                 "  mtx_avel_y REAL NOT NULL,"
                 "  mtx_avel_z REAL NOT NULL,"
                 "  mtx_phi    REAL NOT NULL,"
                 "  mtx_theta  REAL NOT NULL,"
                 "  mtx_psi    REAL NOT NULL,"
                 "  PRIMARY KEY(time)"
                 " )"
                 );
