...
main(int argc, char** argv)
{
  ...
  options.executable("dune-modular")
  ...
  {
    DUNE::Tasks::ModuleLoader::loadAll(context);
  ...
  else if (options.value("--dump-task-params") != "")
  {
    ...
    DUNE::Tasks::ModuleLoader::load(context, task_name);
  ...
  DUNE::Tasks::ModuleLoader::load(context);
