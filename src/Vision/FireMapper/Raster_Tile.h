...
public:
        ...
        Pixel_Range get_Rastercorners(double x_left,double x_right,double y_up, double y_down);///Gets the equivqlent pixel position for the coordinates of the corners .
