...
macro(dune_probe_cxx)
  ...
  if(NOT DUNE_CXX_NAME)
    ...
    if(DUNE_CXX_GNU)
      ...
      check_cxx_compiler_flag(-Wimplicit-fallthrough=3 has_wimplicit_fallthrough_3)
      if(has_wimplicit_fallthrough_3)
        set(DUNE_CXX_FLAGS "${DUNE_CXX_FLAGS} -Wimplicit-fallthrough=3")
        set(DUNE_C_FLAGS "${DUNE_C_FLAGS} -Wimplicit-fallthrough=3")
      endif()
  ...
  if(NOT DUNE_CXX_NAME)
    ...
    if(DUNE_CXX_MICROSOFT)
      ...
      check_cxx_compiler_flag(/bigobj _bigobj)
      if(_bigobj)
        set(DUNE_CXX_FLAGS "${DUNE_CXX_FLAGS} /bigobj")
      endif()
