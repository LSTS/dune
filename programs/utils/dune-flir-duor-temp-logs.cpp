...
void
printCSVLine(char separator);
int
toUnixTime(string date_time);
float
toDecimalDegrees(string dms);
...
toUnixTime(string date_time) {
	...
	int year = stoi(date_time.substr(0, 4)),
		...
		gmtOffset = stoi(date_time.substr(23,26));
