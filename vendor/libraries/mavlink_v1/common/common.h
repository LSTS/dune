...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_DO_TRIGGER_CONTROL=2003, /* Enable or disable on-board camera triggering system. |Trigger enable/disable (0 for disable, 1 for start), -1 to ignore| Shutter integration time (in ms), -1 to ignore| 1 to reset the trigger sequence, -1/0 to ignore|  */
