...
enum ParamName : int {
  ...
  PN_CURRENT_CONTROL_MAX_INTEGRAL_ACCUMULATOR_ERROR = 404,
  PN_CURRENT_CONTROL_MAX_UPDATE_DELTA = 405,
  PN_CURRENT_CONTROL_PID_GAINS = 406,
  PN_CURRENT_FAULT_DETECTION = 407,
  PN_CURRENT_LOWER_THRESHOLD = 408,
  PN_CURRENT_MOVING_AVERAGE_WINDOW = 409,
  PN_CURRENT_PROFILER_AVAILABLE = 410,
  PN_CURRENT_PROFILER_BLANKING_DISTANCE = 411,
  PN_CURRENT_PROFILER_CELL_SIZE = 412,
  PN_CURRENT_PROFILER_ENABLED = 413,
  PN_CURRENT_PROFILER_GET_AT_NTH_PING = 414,
  PN_CURRENT_PROFILER_NUMBER_OF_CELLS = 415,
  PN_CURRENT_RAW_OFFSET = 416,
  PN_CURRENT_SOURCE_ENTITY_LABEL = 417,
  PN_CURRENT_THRESHOLD_IN_AMPERES = 418,
  PN_CURRENT_UPPER_THRESHOLD = 419,
  PN_CURRENT_VALUE_CHARGER_REJECT = 420,
  PN_CUSTOM_FILTERS = 421,
  PN_CUSTOM_SERVICE_TYPE = 422,
  PN_DATA_BITS = 423,
  PN_DATA_GAIN = 424,
  PN_DATA_POINTS = 425,
  PN_DATA_PORT = 426,
  PN_DATA_RATE = 427,
  PN_DATA_RATE_1 = 428,
  PN_DATA_SAMPLING_FREQUENCY = 429,
  PN_DATA_TIMEOUT = 430,
  PN_DAYS_FORWARD = 431,
  PN_DB_PATH = 432,
  PN_DCCL_ENCODING = 433,
  PN_DEACTIVATION_TIME = 434,
  PN_DEBUG = 435,
  PN_DEBUG_LEVEL = 436,
  PN_DEBUG_PATH = 437,
  PN_DEFAULT_ALTITUDE = 438,
  PN_DEFAULT_DEPTH = 439,
  PN_DEFAULT_LOITER_RADIUS = 440,
  PN_DEFAULT_MONITORING = 441,
  PN_DEFAULT_MONITORING_HARDWARE = 442,
  PN_DEFAULT_SMS_RECIPIENT_NUMBER = 443,
  PN_DEFAULT_SPEED = 444,
  PN_DEFAULT_SPEED_DOWN = 445,
  PN_DEFAULT_SPEED_EAST = 446,
  PN_DEFAULT_SPEED_NORTH = 447,
  PN_DEFAULT_SPEED_UNITS = 448,
  PN_DEFAULT_Z = 449,
  PN_DEFAULT_Z_UNITS = 450,
  PN_DELTA_BOUNDS = 451,
  PN_DEPTH_ACTION_DEAD_ZONE = 452,
  PN_DEPTH_AND_HEADING_CONTROL = 453,
  PN_DEPTH_CALIBRATION = 454,
  PN_DEPTH_ENTITY = 455,
  PN_DEPTH_INCREMENT = 456,
  PN_DEPTH_INTEGRAL_LIMIT = 457,
  PN_DEPTH_OFFSET = 458,
  PN_DEPTH_OF_DOCK = 459,
  PN_DEPTH_PID_GAINS = 460,
  PN_DEPTH_RATE = 461,
  PN_DEPTH_SENSOR = 462,
  PN_DEPTH_SENSOR_LOCALIZATION_IN_X_AXIS = 463,
  PN_DEPTH_SOURCE_ENTITY_LABEL = 464,
  PN_DEPTH_TIMEOUT = 465,
  PN_DEPTH_TIMEOUT_1 = 466,
  PN_DEPTH_TO_PITCH_PID_SAMPLING_RATE_RELATION = 467,
  PN_DESIREDZ_FILTER = 468,
  PN_DESTINATION = 469,
  PN_DEVICE_ADDRESS = 470,
  PN_DEVICE_INPUT_TIMEOUT = 471,
  PN_DEVICE_ORIENTATION = 472,
  PN_DEVICE_ORIENTATION_1 = 473,
  PN_DEVICE_POSITION = 474,
  PN_DEVICE_POSITION_1 = 475,
  PN_DEVICE_SERIAL_NUMBER = 476,
  PN_DEVICE_UPDATES_PERIODICITY = 477,
  PN_DIFFERENTIAL_MODE = 478,
  PN_DIGITAL_CHANNEL_1_CONVERSION = 479,
  PN_DIGITAL_CHANNEL_1_ENTITY_LABEL = 480,
  PN_DIGITAL_CHANNEL_1_MESSAGE = 481,
  PN_DIGITAL_CHANNEL_2_CONVERSION = 482,
  PN_DIGITAL_CHANNEL_2_ENTITY_LABEL = 483,
  PN_DIGITAL_CHANNEL_2_MESSAGE = 484,
  PN_DIGITAL_CHANNEL_3_CONVERSION = 485,
  PN_DIGITAL_CHANNEL_3_ENTITY_LABEL = 486,
  PN_DIGITAL_CHANNEL_3_MESSAGE = 487,
  PN_DIGITAL_CHANNEL_4_CONVERSION = 488,
  PN_DIGITAL_CHANNEL_4_ENTITY_LABEL = 489,
  PN_DIGITAL_CHANNEL_4_MESSAGE = 490,
  PN_DIGITAL_CHANNEL_5_CONVERSION = 491,
  PN_DIGITAL_CHANNEL_5_ENTITY_LABEL = 492,
  PN_DIGITAL_CHANNEL_5_MESSAGE = 493,
  PN_DIGITAL_MAP_PATH = 494,
  PN_DISABLE_ANALOG_THRUST = 495,
  PN_DISABLE_GPS_FOR_DEBUG = 496,
  PN_DISCARD_AIS_TIMEOUT = 497,
  PN_DISCART_PRESSURE_MEASUREMENTS = 498,
  PN_DISLODGE_ATTEMPTS = 499,
  PN_DISLODGE_BURSTS = 500,
  PN_DISLODGE_BURST_TIME = 501,
  PN_DISLODGE_INTERVAL_TIME = 502,
  PN_DISLODGE_MINIMUM_DISTANCE = 503,
  PN_DISLODGE_SAFE_DEPTH_GAP = 504,
  PN_DISPATCH_ACOUSTIC_MESSAGES = 505,
  PN_DISPATCH_FUEL_LEVEL = 506,
  PN_DISPATCH_MEDIUM = 507,
  PN_DISPATCH_POWER_OPERATION = 508,
  PN_DISPATCH_VERTICAL_PROFILE = 509,
  PN_DISPLACEMENT_ERROR = 510,
  PN_DISTANCE_BETWEEN_DVL_AND_CG = 511,
  PN_DISTANCE_BETWEEN_GPS_AND_CG = 512,
  PN_DISTANCE_BETWEEN_LBL_AND_GPS = 513,
  PN_DISTANCE_METHOD = 514,
  PN_DISTANCE_STANDARD_DEVIATION = 515,
  PN_DISTANCE_THRESHOLD_FOR_VERTICAL_PROFILE = 516,
  PN_DISTANCE_TOLERANCE = 517,
  PN_DISTRESS_MESSAGE_TTL = 518,
  PN_DIVE_DEPTH = 519,
  PN_DIVE_SECONDS = 520,
  PN_DMS_CH10_BASELINE = 521,
  PN_DMS_CH11_BASELINE = 522,
  PN_DMS_CH12_BASELINE = 523,
  PN_DMS_CH13_BASELINE = 524,
  PN_DMS_CH14_BASELINE = 525,
  PN_DMS_CH15_BASELINE = 526,
  PN_DMS_CH16_BASELINE = 527,
  PN_DMS_CH1_BASELINE = 528,
  PN_DMS_CH2_BASELINE = 529,
  PN_DMS_CH3_BASELINE = 530,
  PN_DMS_CH4_BASELINE = 531,
  PN_DMS_CH5_BASELINE = 532,
  PN_DMS_CH6_BASELINE = 533,
  PN_DMS_CH7_BASELINE = 534,
  PN_DMS_CH8_BASELINE = 535,
  PN_DMS_CH9_BASELINE = 536,
  PN_DOCUMENTATION_URL = 537,
  PN_DRAUGHT = 538,
  PN_DRIVER_ADDRESS = 539,
  PN_DRIVER_PORT = 540,
  PN_DRIVER_TIMEOUT = 541,
  PN_DRIVE_LCD = 542,
  PN_DROP_SERVO_ID = 543,
  PN_DROP_SERVO_VAL = 544,
  PN_DUMMY_CONNECTION = 545,
  PN_DUTY_CYCLE = 546,
  PN_DVL_ABSOLUTE_THRESHOLDS = 547,
  PN_DVL_MODEL = 548,
  PN_DVL_OUTLIER_REJECTION_THRESHOLD_PERCENTAGE = 549,
  PN_DVL_REJECTION_MOVING_AVERAGE_SAMPLES = 550,
  PN_DVL_RELATIVE_THRESHOLDS = 551,
  PN_DVL_RELATIVE_THRESHOLD_TIME_WINDOW = 552,
  PN_DVL_SANITY_TIMEOUT = 553,
  PN_DVL_TIMEOUT = 554,
  PN_DYNAMIC_NODES = 555,
  PN_DYNDNS_UPDATE_PERIODICITY = 556,
  PN_DYNDNS_URL = 557,
  PN_ELEVATOR_COEFFICIENT = 558,
  PN_ELEVATOR_MINIMUM_RADIUS = 559,
  PN_ELEVATOR_RADIUS_TOLERANCE = 560,
  PN_ELEVATOR_VMONITOR_MINIMUM_SPEED = 561,
  PN_ELEVATOR_VMONITOR_TIMEOUT = 562,
  PN_EMULATE_MEDIUM_SENSOR = 563,
  PN_ENABLE_BROADCAST = 564,
  PN_ENABLE_CAMERA_CONFIGURATION = 565,
  PN_ENABLE_CAMERA_STREAMING = 566,
  PN_ENABLE_COLLISION_AVOIDANCE = 567,
  PN_ENABLE_DYNAMIC_DNS = 568,
  PN_ENABLE_GPS_FORCE = 569,
  PN_ENABLE_INPUT_TRIGGER = 570,
  PN_ENABLE_IP_FORWARDING = 571,
  PN_ENABLE_LOOPBACK = 572,
  PN_ENABLE_MESSAGE_ORDINAL = 573,
  PN_ENABLE_MULTICAST = 574,
  PN_ENABLE_REPORTS = 575,
  PN_ENABLE_ROLL_CONTROLLER = 576,
  PN_ENABLE_ROTATION_RATE = 577,
  PN_ENABLE_TELEMETRY_REPORT = 578,
  PN_ENABLE_UAV_HIGH_SPEED_REPORT = 579,
  PN_ENABLE_VAL = 580,
  PN_ENC_FEATURES = 581,
  PN_ENHANCED_USBL = 582,
  PN_ENTITIES = 583,
  PN_ENTITY_LABEL = 584,
  PN_ENTITY_LABEL_ALTITUDE_HARDWARE = 585,
  PN_ENTITY_LABEL_ALTITUDE_SIMULATION = 586,
  PN_ENTITY_LABEL_ANGULAR_VELOCITY = 587,
  PN_ENTITY_LABEL_BOTTOM_DISTANCE = 588,
  PN_ENTITY_LABEL_COMPASS = 589,
  PN_ENTITY_LABEL_CURRENT = 590,
  PN_ENTITY_LABEL_CURRENT_0 = 591,
  PN_ENTITY_LABEL_CURRENT_1 = 592,
  PN_ENTITY_LABEL_CURRENT_2 = 593,
  PN_ENTITY_LABEL_CURRENT_3 = 594,
  PN_ENTITY_LABEL_DEPTH = 595,
  PN_ENTITY_LABEL_DESIRED_WALL_DISTANCE = 596,
  PN_ENTITY_LABEL_DEVICE = 597,
  PN_ENTITY_LABEL_DISLODGE = 598,
  PN_ENTITY_LABEL_DISTANCE = 599,
  PN_ENTITY_LABEL_DROP = 600,
  PN_ENTITY_LABEL_DVL = 601,
  PN_ENTITY_LABEL_ELEVATOR = 602,
  PN_ENTITY_LABEL_EULERANGLES = 603,
  PN_ENTITY_LABEL_FILTERED_WALL_DISTANCE = 604,
  PN_ENTITY_LABEL_FOLLOWPATH = 605,
  PN_ENTITY_LABEL_FORWARD_DISTANCE = 606,
  PN_ENTITY_LABEL_FOR_CHARGER_CURRENT = 607,
  PN_ENTITY_LABEL_FOR_MAIN_VOLTAGE = 608,
  PN_ENTITY_LABEL_FUELLEVEL = 609,
  PN_ENTITY_LABEL_GOTO = 610,
  PN_ENTITY_LABEL_GPS = 611,
  PN_ENTITY_LABEL_GPS_HARDWARE = 612,
  PN_ENTITY_LABEL_GPS_SIMULATION = 613,
  PN_ENTITY_LABEL_HEAVE = 614,
  PN_ENTITY_LABEL_IDLEMANEUVER = 615,
  PN_ENTITY_LABEL_IMU = 616,
  PN_ENTITY_LABEL_LAND = 617,
  PN_ENTITY_LABEL_LAUNCH = 618,
  PN_ENTITY_LABEL_LOITER = 619,
  PN_ENTITY_LABEL_MAIN_EULER_ANGLES = 620,
  PN_ENTITY_LABEL_MEDIUM_SENSOR = 621,
  PN_ENTITY_LABEL_MOBILE_INTERNET = 622,
  PN_ENTITY_LABEL_MOTORS = 623,
  PN_ENTITY_LABEL_MOTOR_CURRENT = 624,
  PN_ENTITY_LABEL_POPUP = 625,
  PN_ENTITY_LABEL_PORT_MOTOR = 626,
  PN_ENTITY_LABEL_ROWS = 627,
  PN_ENTITY_LABEL_SALINITY = 628,
  PN_ENTITY_LABEL_SAMPLE = 629,
  PN_ENTITY_LABEL_SCHEDULEDGOTO = 630,
  PN_ENTITY_LABEL_SECONDARY_EULER_ANGLES = 631,
  PN_ENTITY_LABEL_SERVO_POSITION = 632,
  PN_ENTITY_LABEL_STARBOARD_MOTOR = 633,
  PN_ENTITY_LABEL_STATIONKEEPING = 634,
  PN_ENTITY_LABEL_STATIONKEEPINGEXTENDED = 635,
  PN_ENTITY_LABEL_STREAM_VELOCITY_SOURCE = 636,
  PN_ENTITY_LABEL_TAKEOFF = 637,
  PN_ENTITY_LABEL_TEMPERATURE = 638,
  PN_ENTITY_LABEL_TEMPERATURE_0 = 639,
  PN_ENTITY_LABEL_TEMPERATURE_1 = 640,
  PN_ENTITY_LABEL_TEMPERATURE_2 = 641,
  PN_ENTITY_LABEL_TEMPERATURE_BACKUP = 642,
  PN_ENTITY_LABEL_VOLTAGE = 643,
  PN_ENTITY_LABEL_WALL_DISTANCE = 644,
  PN_ENTITY_LABEL_YAW = 645,
  PN_ENTITY_LABEL_YOYO = 646,
  PN_ERROR_ATTITUDE_COMPENSATION = 647,
  PN_ERROR_LEVEL = 648,
  PN_ERROR_RESET_PERIOD = 649,
  PN_ERROR_STANDARD_DEVIATION = 650,
  PN_ERROR_VOLTAGE_VAL = 651,
  PN_ESCC_IMU_DEVICE = 652,
  PN_ESCC_PSU_DEVICE = 653,
  PN_ESC_DATA_ENTITY_LABEL = 654,
  PN_ESTIMATEDSTATE_FILTER = 655,
  PN_ESTIMATEDSTATE_TIMEOUT = 656,
  PN_ESTIMATED_ENTITY_LABEL_LIST = 657,
  PN_ESTIMATED_ENTITY_POWER_LIST = 658,
  PN_ESTIMATE_COG_AND_SOG = 659,
  PN_ESTIMATION_DURATION = 660,
  PN_ESTIMATION_PERIOD = 661,
  PN_ETA_MINIMUM_SPEED = 662,
  PN_EULER_ANGLES_ENTITY_LABEL = 663,
  PN_EULER_ANGLES_SOURCE_ENTITY_LABELS = 664,
  PN_EULER_TIMEOUT = 665,
  PN_EVENT_DEVICE = 666,
  PN_EVENT_TYPE_TRIGGER = 667,
  PN_EXCLUDE_SYSTEM_NAMES = 668,
  PN_EXECUTE_ON_SYNCHRONIZATION = 669,
  PN_EXECUTION_FREQUENCY = 670,
  PN_EXECUTION_PRIORITY = 671,
  PN_EXPECTED_ACTUATION = 672,
  PN_EXPIRATION_TIME_ABORT_SMS = 673,
  PN_EXPIRATION_TIME_LOST_COMMUNICATIONS = 674,
  PN_EXPONENTIAL_STRETCHING_FACTOR = 675,
  PN_EXPOSURE_TIME = 676,
  PN_EXPOSURE_VAL = 677,
  PN_EXTENDED_CONTROL_CONTROLLER_GAIN = 678,
  PN_EXTENDED_CONTROL_ENABLED = 679,
  PN_EXTENDED_CONTROL_TURN_RATE_GAIN = 680,
  PN_EXTERNAL_INFO_TEXT = 681,
  PN_EXTRA_PITCH_REFERENCE = 682,
  PN_EXTRA_PITCH_VERTICAL_ERROR = 683,
  PN_FACTORY_RESET_DEVICE = 684,
  PN_FAILURE_ERROR_COUNT = 685,
  PN_FAILURE_ERROR_TIMEOUT = 686,
  PN_FAILURE_TIME = 687,
  PN_FALLBACK_MANEUVER_TYPE = 688,
  PN_FALLBACK_POSITION = 689,
  PN_FAULT_TIME = 690,
  PN_FAULT_TIME_COOLDOWN = 691,
  PN_FEEDBACK_QUERYING_FREQUENCY = 692,
  PN_FILE = 693,
  PN_FILTERED_ENTITIES = 694,
  PN_FILTER_AVERAGE_ELEMENTS = 695,
  PN_FILTER_CLUSTER_SIZE = 696,
  PN_FILTER_ENABLED = 697,
  PN_FILTER_LOW_PASS = 698,
  PN_FILTER_MEDIAN_ELEMENTS = 699,
  PN_FILTER_MIN_DISTANCE = 700,
  PN_FILTER_THRESHOLD = 701,
  PN_FINAL_LOITER_POSITION = 702,
  PN_FIN_AERODYNAMIC_CENTER = 703,
  PN_FIN_EFFECT_K = 704,
  PN_FIN_EFFECT_M = 705,
  PN_FIN_EFFECT_MINIMUM_METER_PER_SECOND_VAL = 706,
  PN_FIN_EFFECT_N = 707,
  PN_FIN_EFFECT_RPM_MINIMUM_VAL = 708,
  PN_FIN_EFFECT_VELOCITY_DEPENDENT = 709,
  PN_FIN_EFFECT_VELOCITY_DEPENDENT_UNIT = 710,
  PN_FIXED_CTS_TIME = 711,
  PN_FLIR_DUO_R = 712,
  PN_FLIR_HORIZONTAL_AOV = 713,
  PN_FLIR_TILT_ANGLE = 714,
  PN_FLIR_VERTICAL_AOV = 715,
  PN_FLUSH_INTERVAL = 716,
  PN_FLUSH_IRIDIUM_QUEUE = 717,
  PN_FOCAL_LENGTH = 718,
  PN_FOLLOWREFERENCE_ALTITUDE_INTERVAL = 719,
  PN_FORCE_PITCH_AT_SURFACE = 720,
  PN_FORCE_RESTART = 721,
  PN_FORCE_SPEED_REFERENCE = 722,
  PN_FORCE_TORQUE_CONTROL = 723,
  PN_FORCE_WATER_MODE_AT_BOOT = 724,
  PN_FORMATION_ERROR_BOUNDS = 725,
  PN_FORMATION_FLIGHT = 726,
  PN_FORMATION_FLIGHT_ENTITY = 727,
  PN_FORMATION_GAIN_KF = 728,
  PN_FORWARD_BEAM_WIDTH = 729,
  PN_FORWARD_DISTANCE_STANDARD_DEVIATION = 730,
  PN_FORWARD_RANGE = 731,
  PN_FORWARD_SONAR_ORIENTATION = 732,
  PN_FORWARD_SONAR_POSITION = 733,
  PN_FRAGMENT_STORAGE_TIME = 734,
  PN_FRAMES_PER_SECOND = 735,
  PN_FREQUENCY = 736,
  PN_FUEL_LEVEL_1 = 737,
  PN_FUEL_LEVEL_2 = 738,
  PN_FUEL_LEVEL_3 = 739,
  PN_FUEL_LEVEL_4 = 740,
  PN_FUEL_LEVEL_5 = 741,
  PN_FUEL_LEVEL_ERROR = 742,
  PN_FUEL_LEVEL_STOP_LOGGING = 743,
  PN_FUEL_LEVEL_WARNING_1 = 744,
  PN_FUEL_LEVEL_WARNING_2 = 745,
  PN_FUEL_LEVEL_WARNING_3 = 746,
  PN_FUEL_PERCENTAGE_AUTO_SHUTDOWN = 747,
  PN_FUEL_PERCENTAGE_WARNING = 748,
  PN_FUEL_PREDICTION = 749,
  PN_FUEL_VOLTAGE_AUTO_SHUTDOWN = 750,
  PN_FUEL_VOLTAGE_WARNING = 751,
  PN_FULL_CAPACITY_ENTITY_LABEL = 752,
  PN_GAIN = 753,
  PN_GAIN_MATRIX = 754,
  PN_GAIN_VAL = 755,
  PN_GAMMA = 756,
  PN_GCS_HEARTBEAT = 757,
  PN_GENERAL_MONITOR_TIMEOUT = 758,
  PN_GENERATE_AT_BOOT = 759,
  PN_GENERATE_FAULTS = 760,
  PN_GENERATION = 761,
  PN_GEOPOTENTIAL_ANOMALY = 762,
  PN_GNSS_MAXIMUM_HACC = 763,
  PN_GNSS_MAXIMUM_HDOP = 764,
  PN_GNSS_SOURCE_ENTITY_LABELS = 765,
  PN_GOOD_RANGE_AGE = 766,
  PN_GPIO_DRIVER_POWER = 767,
  PN_GPIO_STROBE = 768,
  PN_GPIO_TRANSDUCER_DETECTION = 769,
  PN_GPIO_WORK_PATH = 770,
  PN_GPS_FORCE_COVARIANCE_ERROR_THRESHOLD = 771,
  PN_GPS_FORCE_GPS_ERROR_THRESHOLD = 772,
  PN_GPS_FORCE_TIME = 773,
  PN_GPS_MAXIMUM_DYNAMIC_HACC_FACTOR = 774,
  PN_GPS_MAXIMUM_HACC = 775,
  PN_GPS_MAXIMUM_HDOP = 776,
  PN_GPS_MOVING_AVERAGE_SAMPLES = 777,
  PN_GPS_NOISE_COVARIANCE = 778,
  PN_GPS_OFFSET_COUNT = 779,
  PN_GPS_TIMEOUT = 780,
  PN_GPS_TIMEOUT_1 = 781,
  PN_GROUND_SPEED_THRESHOLD = 782,
  PN_GROUND_VELOCITY_SOURCE_ENTITY_LABEL = 783,
  PN_GSM_ADDRESS_SECTION = 784,
  PN_GSM_APN = 785,
  PN_GSM_ENTITY_LABEL = 786,
  PN_GSM_MODE = 787,
  PN_GSM_PASSWORD = 788,
  PN_GSM_PIN = 789,
  PN_GSM_USER = 790,
  PN_GUIDANCE_STRATEGY = 791,
  PN_GYRO_RATE_BIAS = 792,
  PN_HACC = 793,
  PN_HARDWARE_ADDRESSES = 794,
  PN_HARDWARE_CLOCK_SYNCHRONIZATION_COMMAND = 795,
  PN_HARDWARE_DEBUG_MODE = 796,
  PN_HARDWARE_RPMS_CONTROL = 797,
  PN_HARD_IRON_CALIBRATION = 798,
  PN_HASH = 799,
  PN_HDOP = 800,
  PN_HEADING_ALIGNMENT = 801,
  PN_HEADING_ALIGNMENT_SENSOR_DIFF = 802,
  PN_HEADING_BIAS_ALIGNMENT_INDEX = 803,
  PN_HEADING_BUFFER_VAL = 804,
  PN_HEADING_COOLDOWN = 805,
  PN_HEADING_INTEGRAL_LIMIT = 806,
  PN_HEADING_OFFSET_THRESHOLD = 807,
  PN_HEADING_PID_GAINS = 808,
  PN_HEADING_RATE = 809,
  PN_HEADING_RATE_BYPASS = 810,
  PN_HEADING_RATE_INTEGRAL_LIMIT = 811,
  PN_HEADING_RATE_OPEN_LOOP = 812,
  PN_HEADING_RATE_PID_GAINS = 813,
  PN_HEADING_TRACKING = 814,
  PN_HEARTBEAT_TIMEOUT = 815,
  PN_HEAVE_MOVING_AVERAGE_SAMPLES = 816,
  PN_HEAVE_PID_GAINS = 817,
  PN_HEIGHT = 818,
  PN_HEIGHT_BANDWIDTH = 819,
  PN_HEIGHT_OF_DOCK = 820,
  PN_HIGHEST_ADDRESS = 821,
  PN_HIGH_FREQUENCY_CHANNELS = 822,
  PN_HIGH_FREQUENCY_RANGE = 823,
  PN_HITL = 824,
  PN_HOME_POSITION_UPDATE = 825,
  PN_HORIZONTAL_THRUSTER_COUNT = 826,
  PN_HORIZONTAL_TOLERANCE = 827,
  PN_HORIZON_TIME_STEP = 828,
  PN_HOURS_FORWARD = 829,
  PN_HYSTERESIS_THRESHOLD_MAXIMUM_DEPTH = 830,
  PN_HYSTERESIS_THRESHOLD_MINIMUM_ALTITUDE = 831,
  PN_I2C_DEVICE = 832,
  PN_IDENTIFIERS = 833,
  PN_IDLE_MODE_ENTITY_LABELS = 834,
  PN_IGNORED_INTERFACES = 835,
  PN_IGNORE_ACKNOWLEDGEMENT = 836,
  PN_IGNORE_FILTER = 837,
  PN_IGNORE_START_MANEUVER = 838,
  PN_ILOS_ENABLED = 839,
  PN_ILOS_INTEGRAL_GAIN = 840,
  PN_ILOS_INTEGRATOR_GAIN = 841,
  PN_ILOS_INTEGRATOR_INITIAL_VAL = 842,
  PN_ILOS_LOOKAHEAD_DISTANCE = 843,
  PN_ILOS_LOOKAHEAD_DISTANCE_1 = 844,
  PN_ILOS_MAXIMUM_CROSS_TRACK_HEADING = 845,
  PN_IMU_ENTITY_LABEL = 846,
  PN_IMU_ROTATION_MATRIX = 847,
  PN_INERTIA = 848,
  PN_INITIALIZATION_STRING_0_COMMAND = 849,
  PN_INITIALIZATION_STRING_0_REPLY = 850,
  PN_INITIALIZATION_STRING_10_COMMAND = 851,
  PN_INITIALIZATION_STRING_10_REPLY = 852,
  PN_INITIALIZATION_STRING_11_COMMAND = 853,
  PN_INITIALIZATION_STRING_11_REPLY = 854,
  PN_INITIALIZATION_STRING_12_COMMAND = 855,
  PN_INITIALIZATION_STRING_12_REPLY = 856,
  PN_INITIALIZATION_STRING_13_COMMAND = 857,
  PN_INITIALIZATION_STRING_13_REPLY = 858,
  PN_INITIALIZATION_STRING_1_COMMAND = 859,
  PN_INITIALIZATION_STRING_1_REPLY = 860,
  PN_INITIALIZATION_STRING_2_COMMAND = 861,
  PN_INITIALIZATION_STRING_2_REPLY = 862,
  PN_INITIALIZATION_STRING_3_COMMAND = 863,
  PN_INITIALIZATION_STRING_3_REPLY = 864,
  PN_INITIALIZATION_STRING_4_COMMAND = 865,
  PN_INITIALIZATION_STRING_4_REPLY = 866,
  PN_INITIALIZATION_STRING_5_COMMAND = 867,
  PN_INITIALIZATION_STRING_5_REPLY = 868,
  PN_INITIALIZATION_STRING_6_COMMAND = 869,
  PN_INITIALIZATION_STRING_6_REPLY = 870,
  PN_INITIALIZATION_STRING_7_COMMAND = 871,
  PN_INITIALIZATION_STRING_7_REPLY = 872,
  PN_INITIALIZATION_STRING_8_COMMAND = 873,
  PN_INITIALIZATION_STRING_8_REPLY = 874,
  PN_INITIALIZATION_STRING_9_COMMAND = 875,
  PN_INITIALIZATION_STRING_9_REPLY = 876,
  PN_INITIALIZATION_TIME = 877,
  PN_INITIAL_ALTITUDE = 878,
  PN_INITIAL_HEADING = 879,
  PN_INITIAL_POSITION = 880,
  PN_INITIAL_REFERENCE_LATITUDE = 881,
  PN_INITIAL_REFERENCE_LONGITUDE = 882,
  PN_INITIAL_ROLL = 883,
  PN_INITIAL_SETTING_MAXIMUM_ALTITUDE = 884,
  PN_INITIAL_SETTING_MAXIMUM_DEPTH = 885,
  PN_INITIAL_SETTING_MAXIMUM_SPEED = 886,
  PN_INITIAL_SETTING_MAXIMUM_VERTICAL_RATE = 887,
  PN_INITIAL_SETTING_MINIMUM_ALTITUDE = 888,
  PN_INITIAL_SETTING_MINIMUM_SPEED = 889,
  PN_INITIAL_SPEED = 890,
  PN_INITIAL_YAW = 891,
  PN_INNOVATION_MOVING_AVERAGE_SAMPLES = 892,
  PN_INPUT_RANGE = 893,
  PN_INPUT_TIMEOUT = 894,
  PN_INPUT_TIMEOUT_1 = 895,
  PN_INPUT_TRIGGER_TYPE = 896,
  PN_INSTANT_MESSAGE_RETRY_COUNT = 897,
  PN_INTERFACE = 898,
  PN_INTERPOLATION_RADIUS = 899,
  PN_INVALID_AT_SURFACE = 900,
  PN_INVALID_READING_PROBABILITY = 901,
  PN_INVERTED_ROTATION = 902,
  PN_INVERT_ORIENTATION_ANGLE = 903,
  PN_IN_MISSION_TIMEOUT = 904,
  PN_IO_PORT_DEVICE = 905,
  PN_IPV4_ADDRESS = 906,
  PN_IPV4_ADDRESS_1 = 907,
  PN_IRIDIUM_ENTITY_LABEL = 908,
  PN_IRIDIUM_MODEM_1_POWER_CHANNEL_ID = 909,
  PN_IRIDIUM_MODEM_2_POWER_CHANNEL_ID = 910,
  PN_IRIDIUM_OPERATION_TIMEOUT = 911,
  PN_IRIDIUM_PAYLOAD_SIZE = 912,
  PN_IRIDIUM_REPORTS_PERIOD = 913,
  PN_IRIDIUM_TEXT_ORIGIN = 914,
  PN_IRIDIUM_UPLOAD_PERIOD = 915,
  PN_IS_MAIN_CPU = 916,
  PN_JPEG_QUALITY = 917,
  PN_KD = 918,
  PN_KEEP_ALIVE_TIMEOUT = 919,
  PN_K_PITCH = 920,
  PN_K_ROLL = 921,
  PN_K_YAW = 922,
  PN_LABEL_OF_GSM_MODEM_POWER = 923,
  PN_LAMBDA = 924,
  PN_LAPS = 925,
  PN_LASER_NAME = 926,
  PN_LAST_CALIBRATION_TIME = 927,
  PN_LATITUDE = 928,
  PN_LATITUDE_DEGREES_OF_GAUSSIAN_PEAK = 929,
  PN_LATITUDE_OF_DOCK = 930,
  PN_LBL_EXPECTED_RANGE_REJECTION_CONSTANTS = 931,
  PN_LBL_MEASURE_NOISE_COVARIANCE = 932,
  PN_LBL_NOISE_COVARIANCE_WITH_IMU = 933,
  PN_LBL_PROCESS_NOISE_COVARIANCE = 934,
  PN_LBL_THRESHOLD = 935,
  PN_LCD_ROW_LENGTH = 936,
  PN_LEADER = 937,
  PN_LEADER_REFERENCE_TIMEOUT = 938,
  PN_LEAK_0_ENTITY_LABEL = 939,
  PN_LEAK_0_MEDIUM_SENSOR = 940,
  PN_LEAK_1_ENTITY_LABEL = 941,
  PN_LEAK_1_MEDIUM_SENSOR = 942,
  PN_LEAK_ENTITIES = 943,
  PN_LED_EXTERNAL_DRIVER = 944,
  PN_LED_EXTERNAL_TRIGGER = 945,
  PN_LED_GPIO = 946,
  PN_LED_MATRIX_DEVICE = 947,
  PN_LED_MODE = 948,
  PN_LED_NAMES = 949,
  PN_LED_PATTERNS = 950,
  PN_LED_PATTERNS_PULSE_WIDTH = 951,
  PN_LED_PERIOD = 952,
  PN_LED_TYPE = 953,
  PN_LED_WIFI_RSSI_THRESHOLD = 954,
  PN_LENGTH_OF_RECEIVE_PINGS = 955,
  PN_LENGTH_OF_TRANSMIT_PINGS = 956,
  PN_LENS_MAKE = 957,
  PN_LENS_MODEL = 958,
  PN_LEVER_ARM_DEPTH = 959,
  PN_LIFESPAN_ESTIMATED_STATE = 960,
  PN_LIFT_COEFFICIENTS = 961,
  PN_LIGHT_ENTITY = 962,
  PN_LIGHT_PARAMETER_LABEL = 963,
  PN_LIGHT_STATE_NO_TARGETS = 964,
  PN_LIGHT_STATE_WITH_TARGETS = 965,
  PN_LOADING_ORDER = 966,
  PN_LOAD_AT_START = 967,
  PN_LOCAL_IPV4_ADDRESS = 968,
  PN_LOCAL_MESSAGES_ONLY = 969,
  PN_LOCAL_PORT = 970,
  PN_LOCATION = 971,
  PN_LOGICAL_ADDRESSES = 972,
  PN_LOG_EVENTS = 973,
  PN_LOG_FOLDER = 974,
  PN_LOG_MESSAGES = 975,
  PN_LOG_PID_PARCELS = 976,
  PN_LOG_PREFIX = 977,
  PN_LOG_RAW_DATA = 978,
  PN_LOG_TIMEOUT = 979,
  PN_LOITERING_RADIUS = 980,
  PN_LOITERING_TOLERANCE = 981,
  PN_LOITER_IN_IDLE = 982,
  PN_LOITER_MINIMUM_RADIUS = 983,
  PN_LOITER_ON_SERVICE_RADIUS = 984,
  PN_LOITER_ON_SERVICE_SPEED = 985,
  PN_LOITER_ON_SERVICE_TIME = 986,
  PN_LOITER_RADIUS = 987,
  PN_LONGITUDE = 988,
  PN_LONGITUDE_DEGREES_OF_GAUSSIAN_PEAK = 989,
  PN_LONGITUDE_OF_DOCK = 990,
  PN_LONGITUDINAL_ACCELERATION_LIMIT = 991,
  PN_LOOKAHEAD = 992,
  PN_LOOK_AHEAD_GAIN = 993,
  PN_LOOPBACK_INTERNAL_MESSAGES = 994,
  PN_LOST_COMMS_PLAN = 995,
  PN_LOST_COMMS_TIMEOUT = 996,
  PN_LOST_COMMUNICATIONS_TIMEOUT = 997,
  PN_LOS_INTEGRAL_GAIN = 998,
  PN_LOS_LOOKAHEAD_DISTANCE = 999,
  PN_LOW_CONFIDENCE_LEVEL = 1000,
  PN_LOW_FREQUENCY_CHANNELS = 1001,
  PN_LOW_FREQUENCY_RANGE = 1002,
  PN_LOW_GAIN = 1003,
  PN_LPF_TAPS = 1004,
  PN_LSF_COMPRESSION_METHOD = 1005,
  PN_LSF_NAME = 1006,
  PN_LSF_VOLUME_DIRECTORIES = 1007,
  PN_LSF_VOLUME_SIZE = 1008,
  PN_MAILBOX_CHECK_PERIODICITY = 1009,
  PN_MAIN_DEPTH_TIMEOUT = 1010,
  PN_MAIN_POWER_CHANNEL = 1011,
  PN_MAIN_UNIT = 1012,
  PN_MANEUVER_HANDLING_TIMEOUT = 1013,
  PN_MANUAL_MODE_ENTITY_LABELS = 1014,
  PN_MASS = 1015,
  PN_MAVLINK_FRAMING = 1016,
  PN_MAXIMUM_AGE = 1017,
  PN_MAXIMUM_ALLOWED_UNCERTAINTY = 1018,
  PN_MAXIMUM_ANGLE = 1019,
  PN_MAXIMUM_BAD_SAMPLES = 1020,
  PN_MAXIMUM_BANK = 1021,
  PN_MAXIMUM_CLOCK_OFFSET = 1022,
  PN_MAXIMUM_CONSECUTIVE_TRANSITIONS = 1023,
  PN_MAXIMUM_DEPTH_ERROR = 1024,
  PN_MAXIMUM_DEVIATION_BEARING = 1025,
  PN_MAXIMUM_DEVIATION_FACTOR = 1026,
  PN_MAXIMUM_DEVIATION_HORIZONTAL = 1027,
  PN_MAXIMUM_DISTANCE_TO_REFERENCE = 1028,
  PN_MAXIMUM_ERRORS = 1029,
  PN_MAXIMUM_EXPECTED_READING = 1030,
  PN_MAXIMUM_EXPOSURE = 1031,
  PN_MAXIMUM_FIN_ROTATION = 1032,
  PN_MAXIMUM_GAIN = 1033,
  PN_MAXIMUM_GAIN_1 = 1034,
  PN_MAXIMUM_GPS_ERROR = 1035,
  PN_MAXIMUM_HEADING_ERROR_TO_THRUST = 1036,
  PN_MAXIMUM_HEADING_RATE = 1037,
  PN_MAXIMUM_HEAVE_REFERENCE = 1038,
  PN_MAXIMUM_HORIZONTAL_POSITION_VARIANCE = 1039,
  PN_MAXIMUM_INCREASE = 1040,
  PN_MAXIMUM_LOG_SIZE = 1041,
  PN_MAXIMUM_LOWER_FAULTS = 1042,
  PN_MAXIMUM_NUMBER_OF_TRIES = 1043,
  PN_MAXIMUM_OBSTACLE_SURVEILLANCE_RANGE = 1044,
  PN_MAXIMUM_PITCH_ACTUATION = 1045,
  PN_MAXIMUM_PITCH_REFERENCE = 1046,
  PN_MAXIMUM_PITCH_VARIATION = 1047,
  PN_MAXIMUM_RADIUS = 1048,
  PN_MAXIMUM_RATE = 1049,
  PN_MAXIMUM_ROTATION_RATE = 1050,
  PN_MAXIMUM_ROTOR_RPM = 1051,
  PN_MAXIMUM_RPM_ACCELERATION = 1052,
  PN_MAXIMUM_RPM_LIMIT = 1053,
  PN_MAXIMUM_RUDDER_ACTUATION = 1054,
  PN_MAXIMUM_SPEED = 1055,
  PN_MAXIMUM_SPEED_ALLOWED = 1056,
  PN_MAXIMUM_SURGE_REFERENCE = 1057,
  PN_MAXIMUM_SWAY_REFERENCE = 1058,
  PN_MAXIMUM_THRUSTER_ACTUATION = 1059,
  PN_MAXIMUM_THRUST_ACTUATION = 1060,
  PN_MAXIMUM_THRUST_DIFFERENTIAL_ACTUATION = 1061,
  PN_MAXIMUM_THRUST_LIMIT = 1062,
  PN_MAXIMUM_THRUST_REFERENCE = 1063,
  PN_MAXIMUM_TIME_TO_ACCEPT_SMS_IN_HOURS = 1064,
  PN_MAXIMUM_TRACK_LENGTH = 1065,
  PN_MAXIMUM_TRANSMISSION_FAILURES_TO_SWITCH = 1066,
  PN_MAXIMUM_TRANSMISSION_RATE = 1067,
  PN_MAXIMUM_UPPER_FAULTS = 1068,
  PN_MAXIMUM_VERTICAL_RATE = 1069,
  PN_MAX_ACTUATION = 1070,
  PN_MAX_MESSAGES_IN_QUEUE = 1071,
  PN_MAX_MOTOR_THRUST = 1072,
  PN_MAX_RANGE = 1073,
  PN_MAX_SPEED = 1074,
  PN_MAX_SPEED_MPS = 1075,
  PN_MAX_STEP_ACTUATION = 1076,
  PN_MAX_STORAGE = 1077,
  PN_MAX_STORAGE_PROCEDURE = 1078,
  PN_MCU_ENTITY_LABEL = 1079,
  PN_MEAN_VALUE_CONDUCTIVITY = 1080,
  PN_MEAN_VALUE_TEMPERATURE = 1081,
  PN_MEASUREMENT_STRING_IDENTIFIER = 1082,
  PN_MEASURES_EULER_ANGLES = 1083,
  PN_MEASURE_NOISE_COVARIANCE = 1084,
  PN_MEDIAN_FILTER = 1085,
  PN_MEDIUM_PERIODICITY = 1086,
  PN_MEDIUM_THRESHOLD = 1087,
  PN_MESSAGES = 1088,
  PN_MESSAGE_FORMAT = 1089,
  PN_MESSAGE_TO_SAMPLE = 1090,
  PN_MESSAGE_TTL = 1091,
  PN_MICROMODEM_PING_TIMEOUT = 1092,
  PN_MINIMUM_ALTITUDE_VAL = 1093,
  PN_MINIMUM_ASCENT_RATE = 1094,
  PN_MINIMUM_CALIBRATION_TIME = 1095,
  PN_MINIMUM_CONDUCTIVITY_FREQUENCY = 1096,
  PN_MINIMUM_DEPTH = 1097,
  PN_MINIMUM_DEPTH_TO_CHECK_ALTITUDE = 1098,
  PN_MINIMUM_DVL_ALTITUDE = 1099,
  PN_MINIMUM_DVL_DEPTH = 1100,
  PN_MINIMUM_FORWARD_RANGE = 1101,
  PN_MINIMUM_GAIN = 1102,
  PN_MINIMUM_GPS_FIXES = 1103,
  PN_MINIMUM_OPERATING_VOLTAGE = 1104,
  PN_MINIMUM_RPM_LIMIT = 1105,
  PN_MINIMUM_SAFE_DISTANCE = 1106,
  PN_MINIMUM_SAFE_DISTANCE_TO_LAND = 1107,
  PN_MINIMUM_SAFE_DISTANCE_TO_VESSELS = 1108,
  PN_MINIMUM_SAMPLES_FOR_ESTIMATE = 1109,
  PN_MINIMUM_SPEED = 1110,
  PN_MINIMUM_SPEED_TO_MAINTAIN_SUBMERGED = 1111,
  PN_MINIMUM_STD_DEV_TO_CHECK_COLLISION = 1112,
  PN_MINIMUM_THRUST_LIMIT = 1113,
  PN_MINIMUM_TILT_ANGLE = 1114,
  PN_MINIMUM_UPDATE_CONFIDENCE = 1115,
  PN_MINI_PACKET_DELAY_AFTER = 1116,
  PN_MINI_PACKET_DELAY_BEFORE = 1117,
  PN_MINUTES_FORWARD = 1118,
  PN_MIN_ACTUATION = 1119,
  PN_MIN_DISPLACE = 1120,
  PN_MIN_SPEED_MPS = 1121,
  PN_MMSI = 1122,
  PN_MODEL = 1123,
  PN_MODEM_ADDRESS = 1124,
  PN_MODEM_PORT = 1125,
  PN_MODEM_SETTINGS_PORT = 1126,
  PN_MODEM_STATE_PORT = 1127,
  PN_MODEM_TYPE = 1128,
  PN_MODE_OF_COMMUNICATION = 1129,
  PN_MONITOR_ANGULAR_VELOCITY = 1130,
  PN_MONITOR_IRIDIUM_MODEMS = 1131,
  PN_MONITOR_IRIDIUM_TASK_LABEL = 1132,
  PN_MONITOR_ONLY_WHEN_SUBMERGED = 1133,
  PN_MOTOR_0_CONVERSION_RPM = 1134,
  PN_MOTOR_0_ENTITY_LABEL = 1135,
  PN_MOTOR_0_LABEL = 1136,
  PN_MOTOR_0_ORIENTATION = 1137,
  PN_MOTOR_0_STATE = 1138,
  PN_MOTOR_1_CONVERSION_RPM = 1139,
  PN_MOTOR_1_ENTITY_LABEL = 1140,
  PN_MOTOR_1_LABEL = 1141,
  PN_MOTOR_1_ORIENTATION = 1142,
  PN_MOTOR_1_STATE = 1143,
  PN_MOTOR_2_CONVERSION_RPM = 1144,
  PN_MOTOR_2_ENTITY_LABEL = 1145,
  PN_MOTOR_2_ORIENTATION = 1146,
  PN_MOTOR_2_STATE = 1147,
  PN_MOTOR_3_CONVERSION_RPM = 1148,
  PN_MOTOR_3_ENTITY_LABEL = 1149,
  PN_MOTOR_3_ORIENTATION = 1150,
  PN_MOTOR_3_STATE = 1151,
  PN_MOTOR_ENTITY_LABEL = 1152,
  PN_MOTOR_ID = 1153,
  PN_MOTOR_IDENTIFIER = 1154,
  PN_MOTOR_POLE_PAIRS = 1155,
  PN_MOTOR_TEMPERATURE_HYSTERESIS = 1156,
  PN_MOTOR_TEMPERATURE_MAXIMUM = 1157,
  PN_MOTOR_WRITE_DIVIDER = 1158,
  PN_MOUNTED_DEPTH = 1159,
  PN_MOUNTED_HEADING = 1160,
  PN_MOVING_AVERAGE_SAMPLES = 1161,
  PN_MOVING_HOME = 1162,
  PN_MPS_CONTROL = 1163,
  PN_MPS_FEEDFORWARD_GAIN = 1164,
  PN_MPS_INTEGRAL_LIMIT = 1165,
  PN_MPS_PID_GAINS = 1166,
  PN_MULTICAST_ADDRESS = 1167,
  PN_NADIR_OFFSET_ANGLE = 1168,
  PN_NAME = 1169,
  PN_NAME_OF_MESSAGE_TO_PRODUCE = 1170,
  PN_NEGATIVE_THRUST_LIMIT = 1171,
  PN_NEW_REFERENCE_TIMEOUT = 1172,
  PN_NOVATEL_SBAS = 1173,
  PN_NO_DISK_STATISTICS = 1174,
  PN_NUMBER_FRAMES_S = 1175,
  PN_NUMBER_LINES_FROM_LOGBOOK_TO_SEND = 1176,
  PN_NUMBER_OF_ATTEMPTS_BEFORE_ERROR = 1177,
  PN_NUMBER_OF_ATTEMPTS_TO_SYNC_CLOCK = 1178,
  PN_NUMBER_OF_BUFFERS = 1179,
  PN_NUMBER_OF_CELLS = 1180,
  PN_NUMBER_OF_CHANNELS = 1181,
  PN_NUMBER_OF_CONSECUTIVE_ERRORS_TO_RESTART_TASK = 1182,
  PN_NUMBER_OF_DISCARDED_INITIAL_SAMPLES = 1183,
  PN_NUMBER_OF_ERRORS_TO_SWITCH_OVER_MODEMS = 1184,
  PN_NUMBER_OF_MOVING_AVERAGE_SAMPLES = 1185,
  PN_NUMBER_OF_PHOTOS_TO_DIVIDE = 1186,
  PN_NUMBER_OF_RETRIES_TO_CONNECT_TO_CPC = 1187,
  PN_NUMBER_OF_SAMPLES_S = 1188,
  PN_NUMBER_OF_SAMPLES_TO_AVERAGE = 1189,
  PN_NUMBER_OF_SATELLITES = 1190,
  PN_NUMBER_OF_TURNS = 1191,
  PN_NUMBER_SAMPLES_PER_S = 1192,
  PN_OMEGA_F_LPF_CUTOFF_FREQUENCY = 1193,
  PN_ONBOARD_CAMERA = 1194,
  PN_OPERATION_MODE = 1195,
  PN_OPTIMISTIC_MODEL_CURRENT = 1196,
  PN_OPTIMISTIC_MODEL_ENERGY = 1197,
  PN_OPTIMISTIC_MODEL_TEMPERATURE = 1198,
  PN_OPTIMISTIC_MODEL_VOLTAGE = 1199,
  PN_OPTIMIZE_FOR_THIS_SPEED = 1200,
  PN_ORIGIN_LATITUDE = 1201,
  PN_ORIGIN_LONGITUDE = 1202,
  PN_OUTPUT_DATA_FORMAT = 1203,
  PN_OUTPUT_DATA_RATE = 1204,
  PN_OUTPUT_DELTAS = 1205,
  PN_OUTPUT_FREQUENCY = 1206,
  PN_OUT_OF_BOUNDS_DEPTH = 1207,
  PN_OVERRIDE_LOCATION = 1208,
  PN_PAN_ACCELERATION = 1209,
  PN_PAN_CONTINUOUS = 1210,
  PN_PAN_SPEED = 1211,
  PN_PARALLEL_PORT_BASE_ADDRESS = 1212,
  PN_PATH = 1213,
  PN_PATTERN_ERROR = 1214,
  PN_PATTERN_FATAL_ERROR = 1215,
  PN_PATTERN_FILTER_DIFFERENCE = 1216,
  PN_PATTERN_FILTER_ENABLED = 1217,
  PN_PATTERN_FUEL_LOW = 1218,
  PN_PATTERN_NORMAL = 1219,
  PN_PATTERN_PLAN_EXECUTING = 1220,
  PN_PATTERN_PLAN_STARTING = 1221,
  PN_PATTERN_SHUTDOWN = 1222,
  PN_PAYLOAD_MESSAGES = 1223,
  PN_PAYLOAD_TIMEOUT = 1224,
  PN_PENCIL_BEAM_SECTOR_WIDTH = 1225,
  PN_PENCIL_BEAM_STEP_SIZE = 1226,
  PN_PENCIL_BEAM_TIME_STEP = 1227,
  PN_PERFORM_CALIBRATION = 1228,
  PN_PERIODICITY_OF_DATA_SAMPLING = 1229,
  PN_PERIODIC_CHECK_DURING_ERROR = 1230,
  PN_PERIOD_ENABLE = 1231,
  PN_PERIOD_REPORT = 1232,
  PN_PERIOD_RETASKMISSION = 1233,
  PN_PERIOD_RETASKWAYPOINT = 1234,
  PN_PERIOD_TARGETOFINTEREST = 1235,
  PN_PESSIMISTIC_MODEL_CURRENT = 1236,
  PN_PESSIMISTIC_MODEL_ENERGY = 1237,
  PN_PESSIMISTIC_MODEL_TEMPERATURE = 1238,
  PN_PESSIMISTIC_MODEL_VOLTAGE = 1239,
  PN_PHI_AH = 1240,
  PN_PHI_CR = 1241,
  PN_PHI_HO = 1242,
  PN_PHI_OT = 1243,
  PN_PHOTOTRIGGER_PCC = 1244,
  PN_PHOTO_OVERLAP = 1245,
  PN_PH_CALIBRATION_BUFFER = 1246,
  PN_PH_SLOPE = 1247,
  PN_PH_VOLTAGE_CALIBRATION_READING = 1248,
  PN_PICTURE_HEIGHT = 1249,
  PN_PICTURE_WIDTH = 1250,
  PN_PIER_POINTS = 1251,
  PN_PING_DELAY = 1252,
  PN_PING_PERIODICITY = 1253,
  PN_PINOUT_0 = 1254,
  PN_PINOUT_1 = 1255,
  PN_PINOUT_2 = 1256,
  PN_PIN_GSM_3G_ON_OFF_PIN = 1257,
  PN_PIN_GSM_3G_SWITCH_PIN = 1258,
  PN_PIN_LED_3G = 1259,
  PN_PIN_NUMBER = 1260,
  PN_PIN_POWERDOWN = 1261,
  PN_PIN_RASP_HB_PIN = 1262,
  PN_PIN_WIFI_LED_PINS = 1263,
  PN_PITCH_ANGLE_AT_SURFACE = 1264,
  PN_PITCH_INTEGRAL_LIMIT = 1265,
  PN_PITCH_PID_GAINS = 1266,
  PN_PITCH_REFERENCE = 1267,
  PN_PITCH_UP_BRAKE = 1268,
  PN_PLAN_GENERATOR_ENTITY_LABEL = 1269,
  PN_PLAN_MODE_ENTITY_LABELS = 1270,
  PN_PLAN_NAME = 1271,
  PN_PLAN_TEMPLATE = 1272,
  PN_POOL_SIZE = 1273,
  PN_POPUP_ELEVATOR_RADIUS = 1274,
  PN_POPUP_MAXIMUM_DISTANCE_FROM_STATION = 1275,
  PN_POPUP_MINIMUM_DISTANCE = 1276,
  PN_POPUP_MINIMUM_SATELLITES = 1277,
  PN_POPUP_REPORT_AT_POPUPS = 1278,
  PN_PORT = 1279,
  PN_PORTS = 1280,
  PN_PORT_THRUSTER_REVERSE = 1281,
  PN_POSITION_DISSEMINATION_PERIODICITY = 1282,
  PN_POSITION_ERROR_DELAY = 1283,
  PN_POSITION_ERROR_SAMPLES = 1284,
  PN_POSITION_ERROR_THRESHOLD = 1285,
  PN_POSITION_FAULT_DETECTION = 1286,
  PN_POSITION_JUMP_THRESHOLD = 1287,
  PN_POSITION_JUMP_TIME_FACTOR = 1288,
  PN_POSITION_NOISE_COVARIANCE_WITH_IMU = 1289,
  PN_POSITION_OF_HORIZONTAL_FINS = 1290,
  PN_POSITION_RATE_FACTOR = 1291,
  PN_POSITIVE_GRANULARITY = 1292,
  PN_POSITIVE_THRUST_LIMIT = 1293,
  PN_POST_POWER_ON_DELAY = 1294,
  PN_POWER_CHANNEL = 1295,
  PN_POWER_CHANNEL_0_NAME = 1296,
  PN_POWER_CHANNEL_0_STATE = 1297,
  PN_POWER_CHANNEL_10_ENTITY_LABEL = 1298,
  PN_POWER_CHANNEL_10_MAX_CURRENT = 1299,
  PN_POWER_CHANNEL_10_NAME = 1300,
  PN_POWER_CHANNEL_10_STATE = 1301,
  PN_POWER_CHANNEL_10_TURN_ON = 1302,
  PN_POWER_CHANNEL_11_ENTITY_LABEL = 1303,
  PN_POWER_CHANNEL_11_MAX_CURRENT = 1304,
  PN_POWER_CHANNEL_11_NAME = 1305,
  PN_POWER_CHANNEL_11_STATE = 1306,
  PN_POWER_CHANNEL_11_TURN_ON = 1307,
  PN_POWER_CHANNEL_12V_STATE = 1308,
  PN_POWER_CHANNEL_12_ENTITY_LABEL = 1309,
  PN_POWER_CHANNEL_12_MAX_CURRENT = 1310,
  PN_POWER_CHANNEL_12_NAME = 1311,
  PN_POWER_CHANNEL_12_STATE = 1312,
  PN_POWER_CHANNEL_12_TURN_ON = 1313,
  PN_POWER_CHANNEL_13_ENTITY_LABEL = 1314,
  PN_POWER_CHANNEL_13_MAX_CURRENT = 1315,
  PN_POWER_CHANNEL_13_NAME = 1316,
  PN_POWER_CHANNEL_13_STATE = 1317,
  PN_POWER_CHANNEL_13_TURN_ON = 1318,
  PN_POWER_CHANNEL_14_ENTITY_LABEL = 1319,
  PN_POWER_CHANNEL_14_MAX_CURRENT = 1320,
  PN_POWER_CHANNEL_14_NAME = 1321,
  PN_POWER_CHANNEL_14_STATE = 1322,
  PN_POWER_CHANNEL_14_TURN_ON = 1323,
  PN_POWER_CHANNEL_15_ENTITY_LABEL = 1324,
  PN_POWER_CHANNEL_15_MAX_CURRENT = 1325,
  PN_POWER_CHANNEL_15_NAME = 1326,
  PN_POWER_CHANNEL_15_STATE = 1327,
  PN_POWER_CHANNEL_15_TURN_ON = 1328,
  PN_POWER_CHANNEL_16_ENTITY_LABEL = 1329,
  PN_POWER_CHANNEL_16_MAX_CURRENT = 1330,
  PN_POWER_CHANNEL_16_NAME = 1331,
  PN_POWER_CHANNEL_16_STATE = 1332,
  PN_POWER_CHANNEL_16_TURN_ON = 1333,
  PN_POWER_CHANNEL_17_ENTITY_LABEL = 1334,
  PN_POWER_CHANNEL_17_MAX_CURRENT = 1335,
  PN_POWER_CHANNEL_17_NAME = 1336,
  PN_POWER_CHANNEL_17_STATE = 1337,
  PN_POWER_CHANNEL_17_TURN_ON = 1338,
  PN_POWER_CHANNEL_18_ENTITY_LABEL = 1339,
  PN_POWER_CHANNEL_18_MAX_CURRENT = 1340,
  PN_POWER_CHANNEL_18_TURN_ON = 1341,
  PN_POWER_CHANNEL_19_ENTITY_LABEL = 1342,
  PN_POWER_CHANNEL_19_MAX_CURRENT = 1343,
  PN_POWER_CHANNEL_19_TURN_ON = 1344,
  PN_POWER_CHANNEL_1_ENTITY_LABEL = 1345,
  PN_POWER_CHANNEL_1_MAX_CURRENT = 1346,
  PN_POWER_CHANNEL_1_NAME = 1347,
  PN_POWER_CHANNEL_1_STATE = 1348,
  PN_POWER_CHANNEL_20_ENTITY_LABEL = 1349,
  PN_POWER_CHANNEL_20_MAX_CURRENT = 1350,
  PN_POWER_CHANNEL_20_TURN_ON = 1351,
  PN_POWER_CHANNEL_21_ENTITY_LABEL = 1352,
  PN_POWER_CHANNEL_21_MAX_CURRENT = 1353,
  PN_POWER_CHANNEL_21_TURN_ON = 1354,
  PN_POWER_CHANNEL_22_ENTITY_LABEL = 1355,
  PN_POWER_CHANNEL_22_MAX_CURRENT = 1356,
  PN_POWER_CHANNEL_22_TURN_ON = 1357,
  PN_POWER_CHANNEL_23_ENTITY_LABEL = 1358,
  PN_POWER_CHANNEL_23_MAX_CURRENT = 1359,
  PN_POWER_CHANNEL_23_TURN_ON = 1360,
  PN_POWER_CHANNEL_24_ENTITY_LABEL = 1361,
  PN_POWER_CHANNEL_24_MAX_CURRENT = 1362,
  PN_POWER_CHANNEL_24_TURN_ON = 1363,
  PN_POWER_CHANNEL_25_ENTITY_LABEL = 1364,
  PN_POWER_CHANNEL_25_MAX_CURRENT = 1365,
  PN_POWER_CHANNEL_25_TURN_ON = 1366,
  PN_POWER_CHANNEL_2_ENTITY_LABEL = 1367,
  PN_POWER_CHANNEL_2_MAX_CURRENT = 1368,
  PN_POWER_CHANNEL_2_NAME = 1369,
  PN_POWER_CHANNEL_2_STATE = 1370,
  PN_POWER_CHANNEL_3_ENTITY_LABEL = 1371,
  PN_POWER_CHANNEL_3_MAX_CURRENT = 1372,
  PN_POWER_CHANNEL_3_NAME = 1373,
  PN_POWER_CHANNEL_3_STATE = 1374,
  PN_POWER_CHANNEL_3_TURN_ON = 1375,
  PN_POWER_CHANNEL_4_ENTITY_LABEL = 1376,
  PN_POWER_CHANNEL_4_MAX_CURRENT = 1377,
  PN_POWER_CHANNEL_4_NAME = 1378,
  PN_POWER_CHANNEL_4_STATE = 1379,
  PN_POWER_CHANNEL_4_TURN_ON = 1380,
  PN_POWER_CHANNEL_5V_STATE = 1381,
  PN_POWER_CHANNEL_5_ENTITY_LABEL = 1382,
  PN_POWER_CHANNEL_5_MAX_CURRENT = 1383,
  PN_POWER_CHANNEL_5_NAME = 1384,
  PN_POWER_CHANNEL_5_STATE = 1385,
  PN_POWER_CHANNEL_5_TURN_ON = 1386,
  PN_POWER_CHANNEL_6_ENTITY_LABEL = 1387,
  PN_POWER_CHANNEL_6_MAX_CURRENT = 1388,
  PN_POWER_CHANNEL_6_NAME = 1389,
  PN_POWER_CHANNEL_6_STATE = 1390,
  PN_POWER_CHANNEL_6_TURN_ON = 1391,
  PN_POWER_CHANNEL_7_ENTITY_LABEL = 1392,
  PN_POWER_CHANNEL_7_MAX_CURRENT = 1393,
  PN_POWER_CHANNEL_7_NAME = 1394,
  PN_POWER_CHANNEL_7_STATE = 1395,
  PN_POWER_CHANNEL_7_TURN_ON = 1396,
  PN_POWER_CHANNEL_8_ENTITY_LABEL = 1397,
  PN_POWER_CHANNEL_8_MAX_CURRENT = 1398,
  PN_POWER_CHANNEL_8_NAME = 1399,
  PN_POWER_CHANNEL_8_STATE = 1400,
  PN_POWER_CHANNEL_8_TURN_ON = 1401,
  PN_POWER_CHANNEL_9_ENTITY_LABEL = 1402,
  PN_POWER_CHANNEL_9_MAX_CURRENT = 1403,
  PN_POWER_CHANNEL_9_NAME = 1404,
  PN_POWER_CHANNEL_9_STATE = 1405,
  PN_POWER_CHANNEL_9_TURN_ON = 1406,
  PN_POWER_CHANNEL_CAMERA = 1407,
  PN_POWER_CHANNEL_CPU = 1408,
  PN_POWER_CHANNEL_H_12V1_NAME = 1409,
  PN_POWER_CHANNEL_H_12V1_STATE = 1410,
  PN_POWER_CHANNEL_H_12V2_NAME = 1411,
  PN_POWER_CHANNEL_H_12V2_STATE = 1412,
  PN_POWER_CHANNEL_H_12V3_NAME = 1413,
  PN_POWER_CHANNEL_H_12V3_STATE = 1414,
  PN_POWER_CHANNEL_H_5V_NAME = 1415,
  PN_POWER_CHANNEL_H_5V_STATE = 1416,
  PN_POWER_CHANNEL_H_AUX0_NAME = 1417,
  PN_POWER_CHANNEL_H_AUX0_STATE = 1418,
  PN_POWER_CHANNEL_H_AUX1_NAME = 1419,
  PN_POWER_CHANNEL_H_AUX1_STATE = 1420,
  PN_POWER_CHANNEL_H_MOT0_NAME = 1421,
  PN_POWER_CHANNEL_H_MOT0_STATE = 1422,
  PN_POWER_CHANNEL_H_MOT1_NAME = 1423,
  PN_POWER_CHANNEL_H_MOT1_STATE = 1424,
  PN_POWER_CHANNEL_H_VR0_NAME = 1425,
  PN_POWER_CHANNEL_H_VR0_STATE = 1426,
  PN_POWER_CHANNEL_H_VR1_NAME = 1427,
  PN_POWER_CHANNEL_H_VR1_STATE = 1428,
  PN_POWER_CHANNEL_LABEL_FOR_IRIDIUM_1 = 1429,
  PN_POWER_CHANNEL_LABEL_FOR_IRIDIUM_2 = 1430,
  PN_POWER_CHANNEL_LABEL_FOR_THRUSTER = 1431,
  PN_POWER_CHANNEL_MAIN_NAME = 1432,
  PN_POWER_CHANNEL_NAME = 1433,
  PN_POWER_CHANNEL_NAMES = 1434,
  PN_POWER_CHANNEL_NAME_1 = 1435,
  PN_POWER_CHANNEL_STROBE = 1436,
  PN_POWER_DATA_10_ENTITY_LABEL = 1437,
  PN_POWER_DATA_11_ENTITY_LABEL = 1438,
  PN_POWER_DATA_12_ENTITY_LABEL = 1439,
  PN_POWER_DATA_13_ENTITY_LABEL = 1440,
  PN_POWER_DATA_14_ENTITY_LABEL = 1441,
  PN_POWER_DATA_15_ENTITY_LABEL = 1442,
  PN_POWER_DATA_16_ENTITY_LABEL = 1443,
  PN_POWER_DATA_17_ENTITY_LABEL = 1444,
  PN_POWER_DATA_18_ENTITY_LABEL = 1445,
  PN_POWER_DATA_19_ENTITY_LABEL = 1446,
  PN_POWER_DATA_1_ENTITY_LABEL = 1447,
  PN_POWER_DATA_20_ENTITY_LABEL = 1448,
  PN_POWER_DATA_21_ENTITY_LABEL = 1449,
  PN_POWER_DATA_22_ENTITY_LABEL = 1450,
  PN_POWER_DATA_23_ENTITY_LABEL = 1451,
  PN_POWER_DATA_2_ENTITY_LABEL = 1452,
  PN_POWER_DATA_3_ENTITY_LABEL = 1453,
  PN_POWER_DATA_4_ENTITY_LABEL = 1454,
  PN_POWER_DATA_5_ENTITY_LABEL = 1455,
  PN_POWER_DATA_6_ENTITY_LABEL = 1456,
  PN_POWER_DATA_7_ENTITY_LABEL = 1457,
  PN_POWER_DATA_8_ENTITY_LABEL = 1458,
  PN_POWER_DATA_9_ENTITY_LABEL = 1459,
  PN_POWER_GPIO = 1460,
  PN_POWER_LEVEL = 1461,
  PN_POWER_MODULE = 1462,
  PN_POWER_OFF_DELAY = 1463,
  PN_POWER_OFF_TIME = 1464,
  PN_POWER_ON_DELAY = 1465,
  PN_PPP_INTERFACE = 1466,
  PN_PPS_DEVICE = 1467,
  PN_PPS_MAXIMUM_OFFSET = 1468,
  PN_PPS_PROPAGATION_DELAY = 1469,
  PN_PREDICTION_HORIZON_GEOG_CONSTRAINTS = 1470,
  PN_PREDICTION_HORIZON_SIMULATION_TIME = 1471,
  PN_PRESSURE_SENSOR_MODE = 1472,
  PN_PRIMARY_MOUNT = 1473,
  PN_PRINT_INCOMING_MESSAGES = 1474,
  PN_PRINT_OUTGOING_MESSAGES = 1475,
  PN_PRIVATE_KEY_FILE = 1476,
  PN_PRNG_SEED = 1477,
  PN_PRNG_TYPE = 1478,
  PN_PROCESS_ACOUSTICOPERATION_MESSAGES = 1479,
  PN_PROCESS_IN_REAL_TIME = 1480,
  PN_PROCESS_NOISE_COVARIANCE = 1481,
  PN_PROFILE_MINIMUM_RANGE = 1482,
  PN_PROFILE_MODE = 1483,
  PN_PROFILE_TILT_ANGLE = 1484,
  PN_PROXIMITY_DISTANCE = 1485,
  PN_PTU_MODEL = 1486,
  PN_PULSE_AUTOSELECTION_MODE = 1487,
  PN_PULSE_LENGTH = 1488,
  PN_PUMP_DELAY = 1489,
  PN_PWM = 1490,
  PN_PWM_CHANNEL = 1491,
  PN_PWM_SETTING = 1492,
  PN_QUADRATIC_DRAG = 1493,
  PN_RADIO_ERROR_CORRECTION = 1494,
  PN_RADIO_MODEL = 1495,
  PN_RADIO_POWER_LEVEL = 1496,
  PN_RADIO_REPORTS = 1497,
  PN_RADIO_REPORTS_PERIODICITY = 1498,
  PN_RADIO_RSSI_REPORT = 1499,
  PN_RADIO_TDM_REPORT = 1500,
  PN_RADIUS_TO_ENDPOINT = 1501,
  PN_RAIL_0_LABEL = 1502,
  PN_RAIL_1_LABEL = 1503,
  PN_RAIL_2_LABEL = 1504,
  PN_RAIL_3_LABEL = 1505,
  PN_RAIL_4_LABEL = 1506,
  PN_RAMP_ACTUATION_LIMIT = 1507,
  PN_RANGE = 1508,
  PN_RANGE_MULTIPLIER = 1509,
  PN_RANGE_REPORTS_DELAY_AFTER = 1510,
  PN_RANGE_REPORTS_DELAY_BEFORE = 1511,
  PN_RATE_LIMITERS = 1512,
  PN_RAW_DATA = 1513,
  PN_RAW_INERTIAL_VECTORS = 1514,
  PN_RC_1_MAX = 1515,
  PN_RC_1_PWM_MAX = 1516,
  PN_RC_1_PWM_MIN = 1517,
  PN_RC_1_REV = 1518,
  PN_RC_2_MAX = 1519,
  PN_RC_2_PWM_MAX = 1520,
  PN_RC_2_PWM_MIN = 1521,
  PN_RC_2_REV = 1522,
  PN_RC_3_MAX = 1523,
  PN_RC_3_MIN = 1524,
  PN_RC_3_PWM_MAX = 1525,
  PN_RC_3_PWM_MIN = 1526,
  PN_RC_3_REV = 1527,
  PN_RECEPTION_TIMEOUT = 1528,
  PN_RECEPTION_WINDOW = 1529,
  PN_REFERENCE_CHANGE_DISTANCE = 1530,
  PN_REFERENCE_GROUND_HEIGHT = 1531,
  PN_REFERENCE_POSITION = 1532,
  PN_REJECT_ALL_LBL_RANGES = 1533,
  PN_REMAINING_CAPACITY_ENTITY_LABEL = 1534,
  PN_REMOTE_HOSTNAME = 1535,
  PN_REMOTE_HOSTS_IP_TO_CHECK_FOR_CONNECTIVITY = 1536,
  PN_REMOTE_USERNAME = 1537,
  PN_REMOVE_DISAPPEARED_OBSTACLES = 1538,
  PN_REPLAY_MESSAGES = 1539,
  PN_REPLY_TIMEOUT = 1540,
  PN_REPLY_TO_SYSTEM_QUERIES = 1541,
  PN_REPORT_GROUND_VELOCITY = 1542,
  PN_REPORT_TIMEOUT = 1543,
  PN_REPORT_YAW = 1544,
  PN_REQUIRE_COG_AND_SOG_FROM_GNSS = 1545,
  PN_RESTART_DEVICE = 1546,
  PN_RESTART_MODEM_GSM = 1547,
  PN_RESTART_THRUSTER = 1548,
  PN_RETASK_MISSION_ID = 1549,
  PN_REVOLUTIONS_TO_SPEED_FACTOR = 1550,
  PN_REVOLUTIONS_TO_SPEED_VARIATION = 1551,
  PN_RHO = 1552,
  PN_ROLL_COMPENSATION_OFFSET_ANGLE = 1553,
  PN_ROLL_COMPENSATION_SPEED_BOUNDS = 1554,
  PN_ROLL_COMPENSATION_SPEED_GAIN = 1555,
  PN_ROLL_COMPENSATION_USE_OFFSET = 1556,
  PN_ROLL_COMPENSATION_USE_SPEED = 1557,
  PN_ROLL_INTEGRAL_LIMIT = 1558,
  PN_ROLL_NOT_VELOCITY_DEPENDENT = 1559,
  PN_ROLL_PID_GAINS = 1560,
  PN_ROLL_TIME_CONST = 1561,
  PN_ROTATION_MATRIX = 1562,
  PN_ROW_WIDTH = 1563,
  PN_RPMS_AT_MAXIMUM_THRUST = 1564,
  PN_RPMS_FEEDFORWARD_GAIN = 1565,
  PN_RPMS_PID_GAINS = 1566,
  PN_RPM_SPEED = 1567,
  PN_RPM_TO_SPEED_ESTIMATION = 1568,
  PN_RTIMU_LIB_CONFIG = 1569,
  PN_RTK_IPV4_ADDRESS = 1570,
  PN_RTK_PORT = 1571,
  PN_RTK_ROLE = 1572,
  PN_RUDDER_COEFFICIENT = 1573,
  PN_RUDDER_ID = 1574,
  PN_RUDDER_SCALE = 1575,
  PN_SAFETY_DEPTH_THRESHOLD = 1576,
  PN_SALINITY = 1577,
  PN_SALINITY_THRESHOLD = 1578,
  PN_SAMPLES_MINIMUM_NEGATIVE_SAMPLES = 1579,
  PN_SAMPLES_MINIMUM_POSITIVE_SAMPLES = 1580,
  PN_SAMPLES_NEGATIVE_THRESHOLD = 1581,
  PN_SAMPLES_PER_AVERAGE = 1582,
  PN_SAMPLES_POSITIVE_THRESHOLD = 1583,
  PN_SAMPLES_TO_SWITCH_GAIN = 1584,
  PN_SAMPLE_EXECUTION_TOLERANCE = 1585,
  PN_SAMPLE_INTERVAL = 1586,
  PN_SAMPLE_PERIOD_MS = 1587,
  PN_SAMPLE_RATE = 1588,
  PN_SAMPLE_SERVO_CLOSE_VAL = 1589,
  PN_SAMPLE_SERVO_OPEN_VAL = 1590,
  PN_SAMPLE_SYRINGE_0_ID = 1591,
  PN_SAMPLE_SYRINGE_1_ID = 1592,
  PN_SAMPLE_SYRINGE_2_ID = 1593,
  PN_SAMPLE_TIME_DURATION = 1594,
  PN_SAMPLING_FREQUENCY = 1595,
  PN_SAMPLING_INTERVAL = 1596,
  PN_SAMPLING_RATE = 1597,
  PN_SANE_ALTITUDE_THRESHOLD = 1598,
  PN_SANE_WORKING_DEPTH = 1599,
  PN_SAVED_IMAGES_DIR = 1600,
  PN_SB_MPC_SURVEILLANCE_RANGE = 1601,
  PN_SCALE_FACTOR = 1602,
  PN_SCALE_FACTOR_A_AH = 1603,
  PN_SCALE_FACTOR_POSITIVE = 1604,
  PN_SCATTERING_DARK_COUNTS = 1605,
  PN_SCATTERING_SCALE_FACTOR = 1606,
  PN_SCHEDULEDGOTO_MAXIMUM_SPEED = 1607,
  PN_SCHEDULEDGOTO_MINIMUM_SPEED = 1608,
  PN_SECONDARY_MOUNT = 1609,
  PN_SECONDARY_UNIT = 1610,
  PN_SECONDS_BEFORE_WAYPOINT = 1611,
  PN_SECONDS_FORWARD = 1612,
  PN_SECONDS_TO_SKIP = 1613,
  PN_SECTIONS_OF_SYSTEM_ADDRESSES = 1614,
  PN_SECTOR_WIDTH = 1615,
  PN_SEND_FULL_PLAN_TO_AUTOPILOT = 1616,
  PN_SEND_HDT = 1617,
  PN_SEND_IMU_DATA = 1618,
  PN_SEND_IRIDIUM_PLAIN_TEXTS = 1619,
  PN_SEND_READY_INTERVAL = 1620,
  PN_SEND_RESET_COMMAND_TO_CPC = 1621,
  PN_SEND_RMC = 1622,
  PN_SEND_SATELLITE_UPDATES = 1623,
  PN_SEND_SELF = 1624,
  PN_SEND_SENTENCES_ON_PULSE = 1625,
  PN_SEND_SMS_TEXT_MESSAGES = 1626,
  PN_SEND_VTG = 1627,
  PN_SEND_ZDA = 1628,
  PN_SENSOR_CLASS = 1629,
  PN_SENTENCE_ORDER = 1630,
  PN_SERIAL_PORT_BAUD_RATE = 1631,
  PN_SERIAL_PORT_CANONICAL_INPUT = 1632,
  PN_SERIAL_PORT_DEVICE = 1633,
  PN_SERIAL_PORT_ECHO = 1634,
  PN_SERIAL_PORT_LOCAL_ECHO = 1635,
  PN_SERIAL_PORT_TIMEOUT = 1636,
  PN_SERVER_ADDRESS = 1637,
  PN_SERVER_ADDRESS_1 = 1638,
  PN_SERVER_PATH = 1639,
  PN_SERVER_PORT = 1640,
  PN_SERVER_PORT_1 = 1641,
  PN_SERVO_DIRECTIONS = 1642,
  PN_SESSION_TIMEOUT = 1643,
  PN_SET_CPC_TO_USE_NAV_AND_IRIDIUM_AT_BOOT = 1644,
  PN_SET_CPU_IN_MODE = 1645,
  PN_SET_MAXIMUM_CPU_FREQUENCY_IN_MHZ = 1646,
  PN_SET_MINIMUM_READ_FLAG = 1647,
  PN_SET_PWM1_CENTER = 1648,
  PN_SET_PWM1_MAXIMUM = 1649,
  PN_SET_PWM1_MINIMUM = 1650,
  PN_SET_PWM1_MODE = 1651,
  PN_SET_PWM2_CENTER = 1652,
  PN_SET_PWM2_MAXIMUM = 1653,
  PN_SET_PWM2_MINIMUM = 1654,
  PN_SET_PWM2_MODE = 1655,
  PN_SET_PWM3_CENTER = 1656,
  PN_SET_PWM3_MAXIMUM = 1657,
  PN_SET_PWM3_MINIMUM = 1658,
  PN_SET_PWM3_MODE = 1659,
  PN_SHALLOW_RADIUS = 1660,
  PN_SHARE_SATURATION = 1661,
  PN_SHUTTER_VALUE_MS = 1662,
  PN_SIMULATEDSTATE_FILTER = 1663,
  PN_SIMULATE_BOTTOM_DISTANCE = 1664,
  PN_SIMULATE_FORWARD_DISTANCE = 1665,
  PN_SIMULATE_PENCIL_BEAM = 1666,
  PN_SIMULATE_PIER = 1667,
  PN_SIMULATION_TYPE = 1668,
  PN_SIMULATOR_ENTITY_LABEL = 1669,
  PN_SINUSOIDAL_AMPLITUDE = 1670,
  PN_SINUSOIDAL_PERIOD = 1671,
  PN_SINUSOIDAL_PHASE = 1672,
  PN_SINUSOIDAL_SLOPE = 1673,
  PN_SIZE_A = 1674,
  PN_SIZE_B = 1675,
  PN_SIZE_C = 1676,
  PN_SIZE_D = 1677,
  PN_SIZE_STANDARD_DEVIATION = 1678,
  PN_SLANT_RANGE_ACCURACY = 1679,
  PN_SLAVE_ENTITIES = 1680,
  PN_SLAVE_ENTITY_NAME = 1681,
  PN_SLAVE_SYSTEM_NAME = 1682,
  PN_SLAVE_SYSTEM_NAMES = 1683,
  PN_SMS_RECIPIENT_NUMBER = 1684,
  PN_SMS_REPORTS = 1685,
  PN_SMS_REPORTS_PERIODICITY = 1686,
  PN_SONAR_ORIENTATION = 1687,
  PN_SONAR_POSITION = 1688,
  PN_SONAR_SAMPLE_PERIOD = 1689,
  PN_SOUND_SPEED_DEFAULT_VAL = 1690,
  PN_SOUND_SPEED_ENTITY_LABEL = 1691,
  PN_SOUND_SPEED_MOVING_AVERAGE_SAMPLES = 1692,
  PN_SOUND_SPEED_ON_WATER = 1693,
  PN_SOUND_SPEED_OUTPUT_FREQUENCY = 1694,
  PN_SOUND_SPEED_THRESHOLD = 1695,
  PN_SOURCE = 1696,
  PN_SOURCE_ALIAS = 1697,
  PN_SOURCE_LEVEL = 1698,
  PN_SOURCE_LEVEL_CONTROL = 1699,
  PN_SOURCE_LEVEL_UNDERWATER = 1700,
  PN_SOURCE_LEVEL_UNKNOWN = 1701,
  PN_SOURCE_LEVEL_WATER = 1702,
  PN_SPEED_MAXIMUM_DELTA = 1703,
  PN_SPEED_MOVING_AVERAGE_SAMPLES = 1704,
  PN_SPEED_OF_SOUND = 1705,
  PN_SPEED_STEP = 1706,
  PN_SPEED_TIME_CONSTANT = 1707,
  PN_SPEED_TOLERANCE = 1708,
  PN_SPEED_TO_RPM_ESTIMATION_PERCENTAGE_LIMIT = 1709,
  PN_SPLIT_PHOTOS = 1710,
  PN_SSH_FLAGS = 1711,
  PN_STABILIZE_GROUND_SPEEDS = 1712,
  PN_STANDARD_DEVIATION = 1713,
  PN_STANDARD_DEVIATION_ANGULAR_VELOCITY = 1714,
  PN_STANDARD_DEVIATION_BEARING_RATE = 1715,
  PN_STANDARD_DEVIATION_CONDUCTIVITY = 1716,
  PN_STANDARD_DEVIATION_DEPTH = 1717,
  PN_STANDARD_DEVIATION_EULER_ANGLES = 1718,
  PN_STANDARD_DEVIATION_GROUND_VELOCITY = 1719,
  PN_STANDARD_DEVIATION_HEADING_OFFSET = 1720,
  PN_STANDARD_DEVIATION_SPEED = 1721,
  PN_STANDARD_DEVIATION_TEMPERATURE = 1722,
  PN_STANDARD_DEVIATION_WATER_VELOCITY = 1723,
  PN_STARBOARD_THRUSTER_REVERSE = 1724,
  PN_START_DELAY = 1725,
  PN_START_GAIN = 1726,
  PN_START_SETUP_TIMEOUT = 1727,
  PN_STATE_COVARIANCE_INITIAL_STATE = 1728,
  PN_STATE_REPORT_FREQUENCY = 1729,
  PN_STATE_SAMPLING_FREQUENCY = 1730,
  PN_STATE_UPDATE_PERIOD = 1731,
  PN_STATIC_DESTINATIONS = 1732,
  PN_STATIONKEEPINGEXTENDED_MINIMUM_RADIUS = 1733,
  PN_STATIONKEEPING_MINIMUM_RADIUS = 1734,
  PN_STATIONKEEPING_RADIUS = 1735,
  PN_STATIONKEEPING_SPEED_IN_RPM = 1736,
  PN_STATIONKEEPING_WHILE_CALIBRATING = 1737,
  PN_STEP_SIZE = 1738,
  PN_STORE_RAW = 1739,
  PN_STREAM_PORT = 1740,
  PN_STREAM_SPEED_TO_EAST = 1741,
  PN_STREAM_SPEED_TO_NORTH = 1742,
  PN_STREAM_VELOCITY_SOURCE = 1743,
  PN_STROBE_DELAY = 1744,
  PN_STROBE_DELAY_US = 1745,
  PN_STROBE_DURATION = 1746,
  PN_STROBE_MODE = 1747,
  PN_STROBE_POLARITY = 1748,
  PN_STUCK_TRIGGER_TIME = 1749,
  PN_SURGE_PID_GAINS = 1750,
  PN_SURROGATE_ENTITY = 1751,
  PN_SURROGATE_POWER_CHANNEL = 1752,
  PN_SURROGATE_SECTION = 1753,
  PN_SURROGATE_SYSTEM = 1754,
  PN_SURROGATE_TASK = 1755,
  PN_SURROUNDINGS_CHECK_FREQUENCY = 1756,
  PN_SWAY_PID_GAINS = 1757,
  PN_SWITCHING_AMPLITUDE = 1758,
  PN_SWITCH_DELAY = 1759,
  PN_SYNC_SETUP_TIMEOUT = 1760,
  PN_SYSTEM_NAME = 1761,
  PN_SYSTEM_NAMES = 1762,
  PN_SYSTEM_TO_JUMP = 1763,
  PN_SYSTEM_TYPE = 1764,
  PN_TAIL_AERODYNAMIC_CENTER = 1765,
  PN_TAKEOFF_PITCH = 1766,
  PN_TARGETOFINTEREST_LATITUDE = 1767,
  PN_TARGETOFINTEREST_LONGITUDE = 1768,
  PN_TARGET_NAME = 1769,
  PN_TARGET_SYSTEM = 1770,
  PN_TASK_ENTITY_LABEL_FOR_IRIDIUM_DRIVER = 1771,
  PN_TASK_LABEL_FOR_SMS_NUMBER = 1772,
  PN_TASK_PARAMETER_FOR_SMS_NUMBER = 1773,
  PN_TCP_ADDRESS = 1774,
  PN_TCP_PORT = 1775,
  PN_TCP_PORT_1 = 1776,
  PN_TCP_PORT_COMMAND = 1777,
  PN_TCP_PORT_DATA = 1778,
  PN_TELEMETRY_RATE = 1779,
  PN_TELEMETRY_SAMPLE_PERIOD = 1780,
  PN_TEMPERATURE_MOVING_AVERAGE_WINDOW = 1781,
  PN_TEMPERATURE_OF_ESC_FAILURE_DEGREES = 1782,
  PN_THIRD_UNIT = 1783,
  PN_THREADS = 1784,
  PN_THRUSTERS_MODELS = 1785,
  PN_THRUSTER_ACT_TO_RPM_FACTOR = 1786,
  PN_THRUSTER_CONVERSION = 1787,
  PN_THRUSTER_CURRENT_CHANNEL_LABEL = 1788,
  PN_THRUSTER_ID = 1789,
  PN_THRUSTER_ID_1 = 1790,
  PN_THRUSTER_INPUT_VOLTAGE_ENTITY_LABELS = 1791,
  PN_THRUSTER_POWER_CHANNEL_LABEL = 1792,
  PN_THRUSTER_POWER_DATA_ENTITY_LABEL = 1793,
  PN_THRUSTER_SCALE = 1794,
  PN_THRUST_ALLOCATION_PINV = 1795,
  PN_THRUST_ASSISTANCE_DURING_TURNS = 1796,
  PN_THRUST_CONTROL_MODE = 1797,
  PN_THRUST_SCALE = 1798,
  PN_TIDE_LEVEL = 1799,
  PN_TILT_ACCELERATION = 1800,
  PN_TILT_SPEED = 1801,
  PN_TIMEOUT = 1802,
  PN_TIMEOUT_ABORT = 1803,
  PN_TIMEOUT_CONNECTION_TO_CPC = 1804,
  PN_TIMEOUT_ERROR = 1805,
  PN_TIMEOUT_FAILURE = 1806,
  PN_TIMEOUT_INPUT = 1807,
  PN_TIMEOUT_MICRO_MODEM_PING = 1808,
  PN_TIMEOUT_NARROW_BAND_PING = 1809,
  PN_TIMEOUT_TCP_RX = 1810,
  PN_TIMEOUT_TCP_TX = 1811,
  PN_TIMEOUT_TO_SWITCH_OVER_MODEMS = 1812,
  PN_TIMEOUT_TRANSMISSION_REQUEST = 1813,
  PN_TIMETOGGLED = 1814,
  PN_TIME_BETWEEN_TRIES = 1815,
  PN_TIME_DELTA_ESTIMATION_PERIODICITY = 1816,
  PN_TIME_DELTA_INITIAL_ESTIMATE_SAMPLES = 1817,
  PN_TIME_DELTA_INITIAL_ESTIMATE_TIMEOUT = 1818,
  PN_TIME_DELTA_MAXIMUM_ALLOWABLE_LATENCY = 1819,
  PN_TIME_GAP = 1820,
  PN_TIME_IN_ERROR_MODE = 1821,
  PN_TIME_MULTIPLIER = 1822,
  PN_TIME_STEP = 1823,
  PN_TIME_TO_ADVANCE_TEMPERATURE = 1824,
  PN_TIME_TO_CHECK_MAILBOX_IN_SECONDS = 1825,
  PN_TIME_TO_CHECK_RSSI_SIGNAL = 1826,
  PN_TIME_TO_STAY_OFF = 1827,
  PN_TIME_TO_STAY_ON = 1828,
  PN_TRACE_INCOMING_MESSAGES = 1829,
  PN_TRACE_OUTGOING_MESSAGES = 1830,
  PN_TRAIN_ANGLE = 1831,
  PN_TRAJECTORY_GAIN_KT = 1832,
  PN_TRANSDUCER_OFFSET = 1833,
  PN_TRANSITION_TIME_GAP = 1834,
  PN_TRANSITION_TO_FW = 1835,
  PN_TRANSITION_TO_MC = 1836,
  PN_TRANSMISSION_DELAY = 1837,
  PN_TRANSMISSION_INTERFACE = 1838,
  PN_TRANSMISSION_SPEED = 1839,
  PN_TRANSMISSION_WINDOW = 1840,
  PN_TRANSMIT_ONLY_UNDERWATER = 1841,
  PN_TRANSPONDER_PING_TIMEOUT = 1842,
  PN_TRANSPONDER_PING_WAIT_TIME = 1843,
  PN_TRANSPORT = 1844,
  PN_TRANSPORTS = 1845,
  PN_TRAVELING_DEPTH = 1846,
  PN_TREX_CONNECTION_TIMEOUT = 1847,
  PN_TREX_ID = 1848,
  PN_TRIGGERED_ACTION = 1849,
  PN_TRIGGER_DELAY = 1850,
  PN_TRIGGER_FREQUENCY = 1851,
  PN_TRIGGER_WITH_DISTANCE = 1852,
  PN_TURBIDITY_DARK_COUNTS = 1853,
  PN_TURBIDITY_SCALE_FACTOR = 1854,
  PN_TURN_AROUND_TIME = 1855,
  PN_TURN_RATE_GAIN = 1856,
  PN_TYPE_ACTIVATION = 1857,
  PN_TYPE_AND_CARGO = 1858,
  PN_UAV_HIGH_SPEED_REPORTS_PERIODICITY = 1859,
  PN_UDP_ADDRESS = 1860,
  PN_UDP_COMMUNICATIONS_MULTICAST_ADDRESS = 1861,
  PN_UDP_COMMUNICATIONS_PORT = 1862,
  PN_UDP_LISTEN_PORT = 1863,
  PN_UDP_PORT = 1864,
  PN_UNDERWATER_COMMUNICATIONS = 1865,
  PN_UNSUPPORTED = 1866,
  PN_UPDATE_ESTIMATE_ANYTIME = 1867,
  PN_UPDATE_PERIOD = 1868,
  PN_USBL_FILTER_MAXIMUM_DEVIATION_FACTOR = 1869,
  PN_USBL_FILTER_MOVING_AVERAGE_SAMPLES = 1870,
  PN_USBL_FORMAT = 1871,
  PN_USBL_MODE = 1872,
  PN_USBL_MODEM_ANNOUNCE_SERVICE = 1873,
  PN_USBL_MODEM_MAX_WAITING_TIME = 1874,
  PN_USBL_NODE_ABSOLUTE_FIX = 1875,
  PN_USBL_NODE_ENABLED = 1876,
  PN_USBL_NODE_INVERTED = 1877,
  PN_USBL_NODE_PERIOD = 1878,
  PN_USBL_NODE_QUICK_NO_RANGE = 1879,
  PN_USBL_NOISE_COVARIANCE = 1880,
  PN_USBL_SERVER = 1881,
  PN_USE_9523N_MODULE = 1882,
  PN_USE_COG_AS_HEADING = 1883,
  PN_USE_CONTROLLER = 1884,
  PN_USE_COUNTER_SYSTEM_OFF = 1885,
  PN_USE_DEFAULT_CONFIGURATION = 1886,
  PN_USE_DEVICE_AT_SURFACE = 1887,
  PN_USE_DYNAMIC_SOUND_SPEED = 1888,
  PN_USE_EXTERNAL_NAV_DATA = 1889,
  PN_USE_FIXED_DEPTH_OFFSET = 1890,
  PN_USE_INTERNAL_PRESSURE_SENSOR_FOR_MEDIUM = 1891,
  PN_USE_LIDB_FOR_IRIDIUM = 1892,
  PN_USE_LINUX_LIQUORIX = 1893,
  PN_USE_LOITER_GAINS_ENABLED = 1894,
  PN_USE_SOFTWARE_FUSE = 1895,
  PN_USE_SPEED_SD_FOR_UNCERTAINTY_CHECK = 1896,
  PN_USE_TCP_OR_UDP = 1897,
  PN_USE_VOLTAGE_VAL = 1898,
  PN_USE_WIFI_ONLY = 1899,
  PN_USING_ANNOUNCE = 1900,
  PN_USING_REMOTESTATE = 1901,
  PN_VALID_COMMANDS = 1902,
  PN_VALUE_AT_PEAK = 1903,
  PN_VALUE_AWAY_FROM_PEAK = 1904,
  PN_VARIABLE_PRIORITIES = 1905,
  PN_VEHICLE_MEDIUM = 1906,
  PN_VEHICLE_SUB_TYPE = 1907,
  PN_VEHICLE_TO_BIND = 1908,
  PN_VEHICLE_TYPE = 1909,
  PN_VERTICAL_MOTOR_ID = 1910,
  PN_VERTICAL_PROFILE_PERIODICITY = 1911,
  PN_VERTICAL_RATE_MAXIMUM_GAIN = 1912,
  PN_VERTICAL_SLOPE_LIMIT = 1913,
  PN_VERTICAL_TOLERANCE = 1914,
  PN_VERY_COLD_MODEL_CURRENT = 1915,
  PN_VERY_COLD_MODEL_ENERGY = 1916,
  PN_VERY_COLD_MODEL_TEMPERATURE = 1917,
  PN_VERY_COLD_MODEL_VOLTAGE = 1918,
  PN_VIDEO_DEVICE = 1919,
  PN_VIDEO_STANDARD = 1920,
  PN_VITAL_ENTITIES = 1921,
  PN_VOLTAGE_ERROR_LEVEL = 1922,
  PN_VOLTAGE_MOVING_AVERAGE_WINDOW = 1923,
  PN_VOLTAGE_OFFSET = 1924,
  PN_VOLTAGE_THRESHOLD_ERROR_LEVEL = 1925,
  PN_VOLTAGE_WARNING_LEVEL = 1926,
  PN_WAIT_FOR_PING_REQUEST = 1927,
  PN_WAKEUP_OPERATING_VOLTAGE = 1928,
  PN_WALL_TRACKING_ABSOLUTE_MAXIMUM_ERROR = 1929,
  PN_WALL_TRACKING_AVERAGE_WINDOW = 1930,
  PN_WALL_TRACKING_DISTANCE_BOUNDS = 1931,
  PN_WALL_TRACKING_DISTANCE_INCREMENTS = 1932,
  PN_WALL_TRACKING_DISTANCE_THRESHOLD = 1933,
  PN_WALL_TRACKING_GAINS = 1934,
  PN_WALL_TRACKING_INTEGRAL_LIMIT = 1935,
  PN_WALL_TRACKING_MAXIMUM_SPEED = 1936,
  PN_WARNING_LEVEL = 1937,
  PN_WATCHDOG_TIMEOUT = 1938,
  PN_WATER_DENSITY = 1939,
  PN_WAVEFORM_ID = 1940,
  PN_WAVE_AMPLITUDE = 1941,
  PN_WAVE_FREQUENCY = 1942,
  PN_WEF_INITIAL_GUESS = 1943,
  PN_WEIGHT_ON_DISTANCE_AT_EVALUATION_INSTANT = 1944,
  PN_WEIGHT_ON_TIME_TO_EVALUATION_INSTANT = 1945,
  PN_WEIGHT_ON_TIME_TO_EVALUATION_INSTANT_FOR_GROUNDING = 1946,
  PN_WET_DATA_TIMEOUT = 1947,
  PN_WHITE_BALANCE_B_FACTOR = 1948,
  PN_WHITE_BALANCE_GAIN_BLUE = 1949,
  PN_WHITE_BALANCE_GAIN_GREEN = 1950,
  PN_WHITE_BALANCE_GAIN_RED = 1951,
  PN_WHITE_BALANCE_R_FACTOR = 1952,
  PN_WIDTH_OF_DOCK = 1953,
  PN_WIDTH_OF_GAUSSIAN = 1954,
  PN_WIFI_COMMUNICATIONS_MULTICAST_ADDRESS = 1955,
  PN_WIFI_COMMUNICATIONS_PORT = 1956,
  PN_WIFI_FORWARD_PERIOD = 1957,
  PN_WIFI_GATEWAY = 1958,
  PN_WING_AERODYNAMIC_CENTER = 1959,
  PN_WP_ACCEPTANCE_RADIUS = 1960,
  PN_WP_THRESHOLD_FOR_FW = 1961,
  PN_WP_THRESHOLD_FOR_MC = 1962,
  PN_X_AXIS_DISTANCE_TO_GPS = 1963,
  PN_X_AXIS_MAXIMUM_VARIATION_LIMIT = 1964,
  PN_YAW_OFFSET = 1965,
  PN_YAW_PID_GAINS = 1966,
  PN_YOYO_CHECK_PATH_ERRORS = 1967,
  PN_YOYO_MAXIMUM_COURSE_ERROR = 1968,
  PN_YOYO_MAXIMUM_CROSS_TRACK_ERROR = 1969,
  PN_YOYO_MAXIMUM_PITCH_VARIATION = 1970,
  PN_YOYO_MINIMUM_ALTITUDE_REFERENCE = 1971,
  PN_ZERO_CONDUCTIVITY_FREQUENCY = 1972,
  PN_ZERO_MODEL_CURRENT = 1973,
  PN_ZERO_MODEL_ENERGY = 1974,
  PN_ZERO_MODEL_TEMPERATURE = 1975,
  PN_ZERO_MODEL_VOLTAGE = 1976,
  PN_Z_AXIS_MAXIMUM_VARIATION_LIMIT = 1977,
  PN_Z_MODE = 1978,
  PN_Z_VAL = 1979,
  PN_UNKNOWN = 1980,
